        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Papierfilter Chemex</h2>
                    <div class="productExcerpt">
                        <p>Passgenauer Kaffeefilter für die Chemex. Für perfekten Kaffee, jedes Mal. Spezielles Filterpapier sorgt für unglaublich klaren, aromatischen Kaffee. Hält Feinpartikel und Kaffeeöle zurück.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/chemexfilter_klein%20(1).png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            ...
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Ruanda-Inzovu.png" alt=""></div>
                            <div class="col"><span>+</span></div>
