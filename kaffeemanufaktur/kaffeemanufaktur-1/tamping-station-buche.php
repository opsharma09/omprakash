         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Tamping Station Puck</h2>
                     <div class="productExcerpt">
                         <p>Andrückstation Wood Black <br>Material: MDF schwarz <br>Maße: Ø 8 cm (innen 6cm) x 2 cm</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="http://codesk.work/design/kaffeemanufaktur/images/tsb_300x300.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>auch als Ablage für den Tamper geeignet</h2>
                         </div>
                     </div>
                 </div>
             </div>
