         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Dekorative Holzbox</h2>
                     <div class="productExcerpt">
                         <p>Dekorative Holzbox mit dem eingebrannten Logo der Hannoverschen Kaffeemanufakur (kein Inhalt).</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="images/holzbox_1.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
