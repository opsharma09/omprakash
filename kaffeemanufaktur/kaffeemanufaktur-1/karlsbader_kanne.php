            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 text-center order-md-last order-lg-first">
                        <h2>Karlsbader Kanne 380ml</h2>
                        <div class="productExcerpt">
                            <p>Karlsbader Kanne des Traditionsherstellers Walküre. Schon seit 100 Jahren produziert Walküre diese in ihrem Werk in Bayreuth. Mit der klassischen Karlsbader Kanne wurde die Zubereitung des Filterkaffees revolutioniert. Man benötigte ab diesem Zeitpunkt praktisch keine Filterpapiere mehr. Was man braucht, ist nur noch das Karlsbader Kännchen aus besonders gehärtetem Porzellan, heißes Wasser und Kaffee.</p>
                        </div>
                    </div>
                    <div class="packshot">
                        <div class="packshotPosition position-static">
                            <img src="http://codesk.work/design/kaffeemanufaktur/images/3-363.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="accessoriesFactsSection" style="background-color:rgb(166,25,46);">
            <div id="accessoriesSectionTop" class="position-relative">
                <div class="dynamicBackgroundBgOuter">
                    ...
                    <div class="dynamicBackgroundBgInner" style="height:45.1vw;background-image:url('http://codesk.work/design/kaffeemanufaktur/images/American-PressElement-7-8.png');"></div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-lg-3 m-auto text-center">
                                <h2>Fakten</h2>
                                <p>Fassungsvermögen 380ml</p><p>Aroma kann sich unverfälscht entfalten</p><p>Kaffee aus der Karlsbader Kanne hat ein unvergleichlich klares und reines Aroma. Keinerlei Fremdgeschmack trübt den Genuß. Milde und Bekömmlichkeit sind unerreicht.</p><p>Seit über 100 Jahren genutzt</p><p>Made in Germany ( Bayreuth)</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/3-363.png" alt=""></div>
                            <div class="col"><span>+</span></div>
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Melange-Hanovera.png" alt=""></div>
                        </div>
                    </div>
