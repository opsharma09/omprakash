            ...
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    ...
                    <div class="productExcerpt">
                        <p>Im nordöstlichen Teil Ruandas wächst ein Spitzenkaffee, der durch seine enorme Fülle besticht. In Verbindung mit seiner angenehmen, leicht spitzen Säure entsteht eine kräftig harmonische Kaffeespezialität.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Ruanda-Inzovu.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/Ruanda_falseZeichenflache-1.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/Ruanda_trueZeichenflache-1.png" alt="fruits"></div>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Ein Kaffee, der stark an reife Beeren erinnert und dazu eine leicht spritzige Säure aufweist. Darüber hinaus überzeugt er durch eine wunderbare Vollmundigkeit mit feinen schokoladigen Nuancen im Abgang.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Himbeere.png" alt="Beerig"></div><span>Himbeere</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Grapefruit.png" alt="Nussig"></div><span>Grapefruit</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Aromen-75.png" alt="Würzig"></div><span>Kakao</span>
            </div>
        </div>
