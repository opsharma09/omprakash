        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Sophies feine Röstung</h2>
                    <div class="productExcerpt">
                        <p>Das Aroma dieser Röstung spiegelt den freien Geist Europas, die Klugheit und die Weichheit der Weiblichkeit wieder und lädt uns ein auf einen Spaziergang durch den Großen Garten Hannovers. Feinste mittel- und südamerikanische Hochlandbohnen verleihen Sophies feiner Röstung einen vollen Körper und eine angenehme Süße.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/2017-SFR.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        ...
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/SophieFG.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Kurfürstlicher Genuss, 100% Arabica</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Kulinarischer Botschafter 2017</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Leicht süßlicher, milder Geschmack mit dezenter Säure und schokoladigen, leicht fruchtigen Nuancen.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Kirsch2.png" alt="Beerig"></div><span>Kirsche</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Stachelbeere.png" alt="Nussig"></div><span>Stachelbeere</span>
            </div>
            <div class="singleFlavorPictureWrapper">
