        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Probierpaket Südamerika</h2>
                    <div class="productExcerpt">
                        <p>Probierpaket bestehend aus unseren drei beliebtesten Kaffees Südamerikas. Erkunden Sie die feinen und aromatischen Kaffees der kleinen Familienplantagen in den subtropischen Bergen Brasiliens und Perus. Können Sie den schokoladig-nussigen Charakter dieser Anbaugebiete herausschmecken?</p>
                        <div><b>Im Paket enthalten:</b></div>
                        <p>Bio Peru (80g) | Brasil Santos (80g) | Bio Brasil (80g) <br>(Details siehe weiter unten)</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/ProbierpaketeElement-20-8.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BIO PERU <br> (80 Gramm)</h2>
                                    <div>Subtropisches Klima in der traditionellen Kaffeeanbauregion Chanchamayo lässt in einer Höhe von 1300–1800 Metern unter Schattenbäumen einen feinen, aromatischen Genuss reifen.</div>
                                    <div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BRASIL SANTOS<br> (80 Gramm)</h2>
