        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Chemex Karaffe für 6 Tassen</h2>
                    <div class="productExcerpt">
                        <p>Der Kaffeezubereiter Chemex ist in jeder Hinsicht einzigartig. Ein unvergleichlich klarer Filterkaffee in herausragendem Design, preisgekrönt und dauerhaft ausgestellt im Museum of Modern Art. Eine Symbiose aus Funktionalität und Design. Die Chemex® wurde 1941 vom deutschstämmigen Chemiker Dr. Peter Schlumbohm in New York entwickelt. Empfehlung: Fruchtige Kaffees wie z.B. Äthiopien Sidamo, Ruanda Inzovu. Die Chemex Papierfilter sind im Vergleich zu herkömmlichen Filtern ca. 20% bis 30% schwerer/dicker und sorgen so für eine optimale Extraktionszeit.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                            <div><img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Ruanda-Inzovu.png" alt=""></div>
                            <div><img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Bio-%C3%84thiopien-Sidamo.png" alt=""></div>
                        </div>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/chemex_kaffeekaraffe_6_tassen_600x600.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/chemex-karaffe_aus_glas_mit_holzhals2.png" alt=""></div>
                            <div class="col"><span>+</span></div>
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Bio-Äthiopien-Sidamo.png" alt=""></div>
                            <div class="col"><span>+</span></div>
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Bio-Äthiopien-Sidamo.png" alt=""></div>
                        </div>
                    </div>
