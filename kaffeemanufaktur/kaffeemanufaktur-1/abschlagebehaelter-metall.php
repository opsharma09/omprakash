         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Abschlagebehälter Metall</h2>
                     <div class="productExcerpt">
                         <p>Diese handliche und praktische Knockbox zählt zu den populärsten ihrer Gattung. Die dick gummierte Basisumrandung und der mit Hilfe des Holzstabs leicht herausnehmbare Innenbehälter garantieren eine einfache und effiziente Handhabung.</p>
                         <p>PVC-Einsatz: spülmaschinenfest <br>Maße: B x T x H: 12 x 12 x 14 cm</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="http://codesk.work/design/kaffeemanufaktur/images/5-kms-kno-box-home-use_300x300.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>Einfach praktisch</h2>
                             <p>Einfache und effiziente Handhabung</p>
                         </div>
                     </div>
                 </div>
             </div>
