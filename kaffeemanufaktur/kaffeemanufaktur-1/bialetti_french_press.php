        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Bialetti French Press</h2>
                    <div class="productExcerpt">
                        <p>Ein guter Kaffee aus der French Press schmeckt intensiv und kräftig und zeichnet sich durch seinen vollen Körper aus. Das liegt an der Kontaktzeit des heißen Wassers mit dem Kaffee. Außerdem hält das Metallsieb der French Press beim Ausgießen zwar das Kaffeemehl zurück, nicht jedoch die im Kaffee enthaltenen geschmacksintensiven Öle. Dadurch bekommt der Kaffee einen ganz anderen Charakter, er ist dadurch vollmundiger, kräftiger und weniger nuanciert als ein Filterkaffee aus dem Handfilter oder der Chemex.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/3-310_padding.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Kräftiger, vollmundiger Kaffee</h1>
                        </div>
                    </div>
                </div>
            </div>
