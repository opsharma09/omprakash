        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Indien Monsooned Malabar</h2>
                    <div class="productExcerpt">
                        <p>In Malabar, im Südwesten Indiens, wird diese Kaffeespezialität nach der Ernte nochmals einige Zeit dem Monsoon ausgesetzt. Die Bohnen erhalten dadurch ihren samtig-milden Geschmack und eine besondere nussig-aromatische Note.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                            ...
                            <div><img src="http://codesk.work/design/kaffeemanufaktur/images/last-one.png" alt=""></div>
                        </div>
                    </div>
                </div>
                <div class="packshot">
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/Indien_falseZeichenflache-1.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/Indien_trueZeichenflache-1.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Ein Exot unter den Kaffees</h1>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h3>Varietät</h3>
                    <p class="mb-0">Kent, Cauwery, Tafarika, San Fìamon</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Herkunft</h3>
                    <p class="mb-0">Indien, Malabar, Karnatakas, Chikmagalur</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntemethode</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <h3>Aufbereitung</h3>
                    <p class="mb-0">trocken/monsooning</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Anbauhöhe</h3>
                    <p class="mb-0">900-1400 m</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntezeit</h3>
                    <p class="mb-0">Oktober-Februar</p>
                </div>
            </div>
        </div>
        <div class="container">
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Sehr säurearmer und kräftiger Kaffee mit leicht erdig-torfigen Nuancen und schokoladigem Nachgeschmack.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Haselnuss.png" alt="Beerig"></div><span>Nussig</span>
            </div>
            <div class="singleFlavorPictureWrapper">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Malz.png" alt="Würzig"></div><span>Erdig</span>
            </div>
        </div>
            ...
            <div id="flavorScoreMainLeftContainerOuter">
                <div id="flavorScoreMainLeftContainerInner">
                    <div class="bubbleScoreWrapper">
                        <span>Körper: voll, intensiv</span>
                    ...
                    <div class="bubbleScoreWrapper">
                        <span>Nachklang: leicht, weich</span>
                        <div class="bubbleScoreContainer">
                            <div class="bubbleScoreBubble">
                                <div></div>
                            </div>
