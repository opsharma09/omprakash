         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Motta Coffee Leveling Tool, 58mm</h2>
                     <div class="productExcerpt">
                         <p>Das Tool sorgt für eine absolut ebene Oberfläche sowie die gleichmäßige, hohlraumfreie Verteilung des Kaffeemehls im Siebträger und reduziert Channelling im Kaffeepuck- und sorgt damit für ein optimiertes Endergebnis. Anschließend kann wie gewohnt getampt werden, denn das Leveln ersetzt nicht das Tampen. Die Höhe ist durch Drehen einstellbar und kann so auf das eigene Equipment abgestimmt werden.</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="http://codesk.work/design/kaffeemanufaktur/images/motta3.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>Mit dem Leveling Tool von Motta lässt sich eine ganz neue Stufe der Präzision erreichen!</h2>
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class="dynamicBackgroundContentOuter">
                 ...
                 <div class="container">
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                             <span>Höhe ab Siebkante</span>
                         </div>
                         <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                             <span>7-13mm, stufenlos einstellbar</span>
                         </div>
                         <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                             <span>Material</span>
                         </div>
                         <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                             <span>Edelstahl / Aluminium schwarz lackiert</span>
                         </div>
                         <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                             <span>Gewicht</span>
                         </div>
