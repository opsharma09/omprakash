        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Aegidius Melange</h2>
                    <div class="productExcerpt">
                        <p>Der Lions Club Hannover Aegidius und die Röstmeister der Hannoverschen Kaffeemanufaktur haben gemeinsam einen edlen Kaffeeblend kreiert, der sich erlesener Hochlandarabicas aus exklusiven Hanglagen in Mittel- und Südamerika bedient. Mit jedem gekauften Pack wird das Aegidius-Haus an der Bult in Hannover unterstützt.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Aegidius-Melange.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/AegidiusBG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/AegidiusFG.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Der Alleskönner im Vollautomaten, 80/20</h1>
                    </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Voller Körper mit schokoladig- nussigen Noten und feiner Würze. Aromatisch und ausgewogen.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Johannesbeere.png" alt="Beerig"></div><span>Johannisbeere</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Wallnuss.png" alt="Nussig"></div><span>Walnuss</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Entkoff_falseZeichenfläche-1.png" alt="Würzig"></div><span>Pfeffer</span>
            </div>
        </div>
