        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Hario Papierfilter</h2>
                    <div class="productExcerpt">
                        <p>Passendes Papier für den Hario V60 Handfilter. Gebleicht für besonders wenig Eigengeschmack. Perfekte Lösung der Öle aus dem Kaffee für ein klares Kaffeeerlebnis.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/3-321.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
