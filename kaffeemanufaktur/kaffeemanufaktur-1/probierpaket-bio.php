        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Probierpaket Bio-Kaffees</h2>
                    <div class="productExcerpt">
                        <p>Probierpaket bestehend aus unseren drei beliebtesten Bio-Kaffees. Ob ausgefallener Single Origin Kaffee mit Noten von Erdnuss und Karamell oder fein ausbalancierter Kaffee Blend, diese Kaffees können Sie bedenkenlos genießen. 100% biologisch angebaut und fair gehandelt.</p>
                        <div><b>Im Paket enthalten:</b></div>
                        <p>Bio Brasil (80g) | Bio Schümli (80g) | Bio Melange Äquatorial (80g) <br>(Details siehe weiter unten)</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/ProbierpaketeElement-17-8.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-10 m-auto">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                <a href="">
                                    <div class="hoverZoom">
                                        <img src="http://codesk.work/design/kaffeemanufaktur/images/2015-BS.png" alt="">
                                    </div>
                                </a>
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BIO SCHüMLI<br> (80 Gramm)</h2>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BIO MELANGE ÄQUATORIAL <br> (80 Gramm)</h2>
