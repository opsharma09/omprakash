...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Drip Coffee Box: Thailand Pang Khon 10 Beutel</h2>
                    <div class="productExcerpt">
                        <p>Drip-Kaffee Box Thailand Pang Khon bestehend aus 10 Filterpäckchen. Mit diesen 10 kleinen Genussmomenten.</p>
                        <p>In Thailand, in der Region Chiang Rai baut ein kleiner Familienbetrieb in traditioneller Handarbeit in kleinen Mengen Kaffee an. Von Hand verlesen und auf Bambustischen getrocknet ist dieser Kaffee von höchster Güte.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/pang_khon_thailand_drip_bags.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/platzhalter_vordergrund.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Vom Bergvolk der Akha ohne Umwege für Ihren Genuss</h1>
                    </div>
                    <div id="fruitsSmallText">
                    <p>Dieser direkt gehandelte Arabica aus der Region Chiang Rai aus Thailand ist ein Hochgenuss für die Sinne.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h3>Varietät</h3>
                    <p class="mb-0">Catimor, Gelber- &amp; Roter Caturra</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Herkunft</h3>
                    <p class="mb-0">Thailand / Chiang Rai</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntemethode</h3>
                    <p class="mb-0">Selective Picking</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Aufbereitung</h3>
                    <p class="mb-0">fully washed / gewaschen</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Anbauhöhe</h3>
                    <p class="mb-0">1300-1500 m</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntezeit</h3>
                            ...
                            <div class="reviews">
                                <div class="star-line">
                                    <div class="line">
                                        ...
                                        <a href="" class="bar">
                                            <span class="filled" style="width: 50%"></span>
                                        </a>
                                    </div>
                                    <div class="line">
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Ein rundes, kräftiges und sehr säurearmes Geschmackskonzept, welches durch seine feine Würze und einen cremig-süßen Abgang zu überzeugen weiß.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/KaffeeProduktElement-13@2x-8.png" alt="Beerig"></div><span>Feige</span>
            </div>
            <div class="singleFlavorPictureWrapper">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/KaffeeProduktElement-15@2x-8.png" alt="Würzig"></div><span>Mandel</span>
            </div>
        </div>
        ...
        <div id="flavorScoreMainContainer">
            <div id="flavorScoreMainLeftContainerOuter">
                <div id="flavorScoreMainLeftContainerInner">
                    ...
                    <div class="bubbleScoreWrapper">
                        <span>Säure: ausgewogen, wild</span>
                        <div class="bubbleScoreContainer">
                            <div class="bubbleScoreBubble">
                                <div></div>
                            </div>
            ...
            <div id="flavorScoreMainRightContainer">
                <div id="radarChartWrapper" class="radarChart" centerx="50" centery="52" totalradius="43" maxscore="10" scores="{'Aroma / Duft':3,'Körper':8,'Säure':1,'Geschmack':4,'Nachklang':7,'Balance':8,'Gesamt':5.1}" bgsrc="https://mlbzyhhzhscu.i.optimole.com/Ut07DWo-pSQK1yQ0/w:auto/h:auto/q:auto/https://hannoversche-kaffeemanufaktur.de/wp-content/uploads/2019/04/radar.png">
                    <style>
                        .radarChartInner {
    ...
    <div id="upsellSection" class="product_wrapper text-center mb-5">
