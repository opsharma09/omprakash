        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Drip Coffee Box: Melange Hanovera 10 Beutel</h2>
                    <div class="productExcerpt">
                        <p>Drip-Kaffee Box Melange Hanovera bestehend aus 10 Filterpäckchen. Mit diesen 10 kleinen Genussmomenten.</p>
                        <p>Unglaublich rund abgestimmte Kaffeemischung aus den feinsten Hochlandarabicas Afrikas, Mittel- und Südamerikas. Ausgewogen und kräftig überzeugt dieser Hannoversche Blend durch Qualität und Regionalität. Ein echter Allrounder, der zum Frühstück, im Büro und zum Sonntagskuchen schmeckt.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/melange_hanoverer_drip_bags.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Unser Klassiker seit 2012 / 100% Arabica</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Kulinarischer Botschafter 2012</p>
                        <p></p>
                    </div>
                </div>
            </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Himbeere.png" alt="Beerig"></div><span>Beerig</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Wallnuss.png" alt="Nussig"></div><span>Nussig</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Zimt.png" alt="Würzig"></div><span>Würzig</span>
            </div>
        </div>
