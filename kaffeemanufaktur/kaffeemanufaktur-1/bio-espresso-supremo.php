        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Bio Espresso Supremo</h2>
                    <div class="productExcerpt">
                        <p>Dieser Espresso eignet sich besonders in Kombination mit Michgetränken. Durch seine fruchtigen Nuancen verwandelt er die Milchgetränke in milde, süßliche Kaffeespezialitäten. Den besonderen Geschmack verdankt dieser Bio Espresso einer wunderbaren Mischung aus feinsten Arabica- und Robustabohnen.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshot-Espresso-Supremo.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/BioEspressoSupremo_BG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/BioEspressoSupremo_FG.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    ...
                    <div id="fruitsSmallText">
                        <p>Feinste Arabica- und Robustabohnen im Verhältnis 70/30</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Filigraner Espresso mit frischer Note, die an Zitrusfrüchte erinnern. Im Abgang sind feine nussige Nuancen erkennbar.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Zitrone.png" alt="Beerig"></div><span>Zitrus</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Limette.png" alt="Nussig"></div><span>Limette</span>
            </div>
            <div class="singleFlavorPictureWrapper">
