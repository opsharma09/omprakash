         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Milchkännchen Joe Frex</h2>
                     <div class="productExcerpt">
                         <p>Mit diesen Milchkännchen erhalten Sie perfekten Milchschaum für Latte Art.</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="http://codesk.work/design/kaffeemanufaktur/images/6-mk03-milk-pitchers_300x300_1.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>perfekten Milchschaum für Latte Art machen</h2>
                         </div>
                     </div>
                 </div>
             </div>
                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col-md-4 col-lg-3 m-auto text-center">
                             <h2>Fakten</h2>
                             <p>Erleichtert beim Aufschäumen die Bildung von feinem, gleichmäßigem Milchschaum</p>
                             <p>Aufschäumkanne aus dickwandigem Edelstahl</p>
                             <p>Die Ausgusstülle ist für Latte Art geeignet</p>
