        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Goldfilter Cilio</h2>
                    <div class="productExcerpt">
                        <p>Ersetzen Sie Ihre Papierfilter durch den Cilio Goldfilter. Sie brauchen keine klammen Filtertüten mehr zu entsorgen, die auf dem Weg zum Mülleimer gerne mal kleckern oder reißen. Statt voller Tüten gibt es volles Aroma. Während die im Papierfilter enthaltenen Leime ausschwemmen und den Geschmack beeinträchtigen können, bringt der speziell gehärtete und 24 Karat vergoldete Dauerfilter die Aromaöle perfekt zur Geltung. Freuen Sie sich auf vollendeten Kaffeegenuss! Sie können den Dauerfilter auch in Ihre Kaffeemaschine einsetzen. Die Reinigung unter fließendem Wasser ist schnell erledigt. Spart Papier und schont die Umwelt.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/3-334-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Der Goldstandard</h1>
                            <p>Ersetzt Papierfilter und bewahrt wichtige Geschmacktsträger</p>
                        </div>
                    </div>
                </div>
            </div>
