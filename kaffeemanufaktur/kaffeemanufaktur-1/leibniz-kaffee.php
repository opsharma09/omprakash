        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Leibniz Kaffee</h2>
                    <div class="productExcerpt">
                        <p>Gottfried Wilhelm Leibniz, Philosoph, Denker, Autor, Erfinder... und Kaffeetrinker. Neben einem guten Rotwein soll Leibniz auch den Kaffee sehr geschätzt haben. Anlässlich des 300. Jahrestages des hannoverschen Universalgelehrten haben wir einen ganz besonderen Kaffee kreiert: eine Mischung, die gleichzeitig bodenständig und geistreich, kräftig und vollmundig ist. Ein Kaffee wie er Leibniz schmecken würde. Entstanden ist die Mischung in Zusammenarbeit mit der Gottfried Wilhelm Leibniz Bibliothek in Hannover.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/2018-LK.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/LeibnizBG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/LeibnizFG.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Kaffee für Philosophen, 100% Arabica</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Kulinarischer Botschafter 2018</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Zimt.png" alt="Beerig"></div><span>Zimt</span>
            </div>
            <div class="singleFlavorPictureWrapper">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Himbeere.png" alt="Würzig"></div><span>Himbeere</span>
            </div>
        </div>
