        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Gabi Filterpapier</h2>
                    <div class="productExcerpt">
                        <p>Das wellenartige Filterpapier begünstigt den Ablauf des Wassers und erzeugt ein Kaffeebett, das beim Brühvorgang flach und eben ist.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/WV-FT-GABI1%20(1).png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>100 Papierfilter für Glowbeans - The Gabi Master</h1>
                        </div>
                    </div>
                </div>
            </div>
