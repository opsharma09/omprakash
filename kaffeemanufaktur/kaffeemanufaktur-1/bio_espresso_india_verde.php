        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Bio Espresso India Verde</h2>
                    <div class="productExcerpt">
                        <p>Unser Bio Espresso India Verde besteht aus einer perfekten Kombination edelster Arabica- und Robusta- Bohnen. Sortenrein bis zum Aromenhöhepunkt geröstet ist dieser Espresso ein Genuss in jeder Zubereitung. Perfekt als Espresso, Café Creme im Vollautomaten. Eine besondere Mischung südamerikanischer Bio-Arabicas und einem indischem Robusta. Fein abgestimmt für ein geschmackvoll fruchtiges Espressoerlebnis mit perfekter, haselnussbrauner Crema.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Bio-Espresso-India-Verde.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Biologisch angebaut und fair gehandelt</h1>
                    </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Zitrone.png" alt="Beerig"></div><span>Zitrusartig
                </span>
            </div>
            <div class="singleFlavorPictureWrapper">
