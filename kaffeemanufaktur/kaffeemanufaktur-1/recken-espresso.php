        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Recken Espresso</h2>
                    <div class="productExcerpt">
                        <p>Ein großer Wurf – gemeinsam komponiert von unseren Recken und den Röstmeistern der Hannoverschen Kaffeemanufaktur. Vollmundig und samtig weich, sehr säurearm, mit beeindruckender Süße und außergewöhnlicher Crema.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshot-Recken-Espresso.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/ReckenEspresso_BG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/ReckenEspresso_FG.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Ein großer Wurf</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>gemeinsam komponiert von unseren Recken und den Röstmeistern der Hannoverschen Kaffeemanufaktur</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Unser Recken Espresso besticht durch beeindruckende Süße und vollmundigen Körper mit schokoladigem, nussigem Abgang.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/nussing.png" alt="Nussig"></div><span>Nussig</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Pfeffer.png" alt="Nussig"></div><span>Würzig</span>
            </div>
        </div>
