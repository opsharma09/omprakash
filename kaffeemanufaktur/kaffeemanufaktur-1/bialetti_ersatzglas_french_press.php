        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Bialetti Ersatzglas für French Press</h2>
                    <div class="productExcerpt">
                        <p>Ersatzglas für die French Press</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/3eeddc006893113263af7ab7ceac2246.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Ersatzglas für die French Press</h1>
                        </div>
                    </div>
                </div>
            </div>
