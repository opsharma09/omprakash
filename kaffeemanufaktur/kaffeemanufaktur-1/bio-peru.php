            ...
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    ...
                    <div class="productExcerpt">
                        <p>Subtropisches Klima in der traditionellen Kaffeeanbauregion Chanchamayo lässt in einer Höhe von 1300–1800 Metern unter Schattenbäumen einen feinen, aromatischen Genuss reifen.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Bio-Peru-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/BioPeru_falseZeichenflache-1.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/BioPeru_trueZeichenflache-1.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Einer unser Allrounder im Sortiment</h1>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h3>Varietät</h3>
                    <p class="mb-0">Caturra, Typica, Pache, Bourbon</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Herkunft</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <h3>Anbauhöhe</h3>
                    <p class="mb-0">1300-1800 m</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntezeit</h3>
                    <p class="mb-0">April-Oktober</p>
                </div>
            </div>
        </div>
        <div class="container">
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Unser Peru ist ein leichter Zentralamerikaner mit mittlerer Fülle, leichter, angenehemer Säure, insgesamt fein aromatisch,leicht nussig im Geschmack.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Anis.png" alt="Beerig"></div><span>Würzig</span>
            </div>
            <div class="singleFlavorPictureWrapper">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Wallnuss.png" alt="Würzig"></div><span>Nussig</span>
            </div>
        </div>
