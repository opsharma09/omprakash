        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Drip Coffee Box: Bio Brasil 10 Beutel</h2>
                    <div class="productExcerpt">
                        <p>Drip-Kaffee Box Bio Brasil bestehend aus 10 Filterpäckchen. Mit diesen 10 kleinen Genussmomenten.</p>
                        <p>Ein hochfeiner Kaffee, der in den Bergen Brasiliens von kleinen Familien angebaut und in sorgfältiger Handarbeit veredelt wird.</p>
                        
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/bio_brasil_drip_bags.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Eine ehrliche Tasse Kaffee</h1>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h3>Varietät</h3>
                    <p class="mb-0">Bourbon, Icatù</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Herkunft</h3>
                    <p class="mb-0">Brasilien, Minas Gerais Sannah</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntemethode</h3>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Aromen-75.png" alt="Beerig"></div><span>Zartbitterschokolade</span>
            </div>
            <div class="singleFlavorPictureWrapper">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Erdnuss.png" alt="Würzig"></div><span>Erdnuss</span>
            </div>
        </div>
