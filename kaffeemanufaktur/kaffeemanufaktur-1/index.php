...
<body>
    ...
    <!--banner started.-->
    <div class="banner">
        <img class="lazy" data-src="images/kaffee%20des%20monats%20juli.jpg" alt="">
    ...
    <div class="features">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h4><img class="lazy" data-src="images/truck.svg" alt=""> <span>Schnelle Lieferung</span></h4>
                    <p>Wir versenden schon ab <b>30€</b> Kostenfrei. Im Kaffee- Abo schon ab <b>20€</b> Kostenfrei 2 - 3 Tage Lieferzeit</p>
                </div>
                <div class="col-md-4">
                    <h4><img class="lazy" data-src="images/fresh.svg" alt=""> <span>Frisch geröstet</span></h4>
                ...
                <div class="col-md-4">
                    <h4><img class="lazy" data-src="images/date.svg" alt=""> <span>Frisch geröstet</span></h4>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="position-relative">
                        <img class="lazy" data-src="images/welcome-1.svg" alt="">
                        <div class="content-overlay">
                            <h4>FILTERKAFFEE</h4>
                            <a href="" class="btn-white">Jetzt bestellen</a>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="position-relative">
                        <img class="lazy" data-src="images/welcome-2.svg" alt="">
                        <div class="content-overlay">
                            <h4>ESPRESSO</h4>
                            <a href="" class="btn-white">Jetzt bestellen</a>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="position-relative">
                        <img class="lazy" data-src="images/welcome-3.svg" alt="">
                        <div class="content-overlay">
                            <h4>ZUBEHÖR</h4>
                            <a href="" class="btn-white">Jetzt bestellen</a>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="position-relative">
                        <img class="lazy" data-src="images/welcome-4.svg" alt="">
                        <div class="content-overlay">
                ...
                <div class="col-md-6">
                    <div class="position-relative">
                        <img class="lazy" data-src="images/welcome-5.svg" alt="">
                        <div class="content-overlay">
                ...
                <div class="col-md-6">
                    <div class="position-relative">
                        <img class="lazy" data-src="images/welcome-6.svg" alt="">
                        <div class="content-overlay">
                            ...
                            <a href="" class="d-block">
                                <div class="image_frame">
                                    <div class="image_wrapper">
                                        <div class="mask"></div>
                                        <img class="lazy" data-src="images/product.png" alt="">
                                    </div>
                                </div>
                                <div class="desc">
                                    ...
                                    <span class="form-row mb-3">
                                        <span class="col-4">
                                            <span class="singleCategoryThumbnail">
                                                <img class="lazy" data-src="images/beerig.png" alt="" title="Beerig">
                                            </span>
                                        </span>
                                        <span class="col-4">
                                            <span class="singleCategoryThumbnail">
                                                <img class="lazy" data-src="images/nussing.png" alt="" title="Nussing">
                                            </span>
                                        </span>
                                        <span class="col-4">
                                            <span class="singleCategoryThumbnail">
                                                <img class="lazy" data-src="images/gewure.png" alt="" title="Gewürze">
                                            </span>
                                        </span>
                                    </span>
                                    <span class="form-row">
    ...
    <section class="coffee_cunsoultent">
        <div class="container-fluid px-0">
            <div class="row no-gutters">
                <div class="col-lg-8">
                    <img class="lazy" data-src="images/Kaffe%20Finder.svg" alt="">
                    <div class="content-overlay">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2>Unser Zubehör</h2>
                <img class="lazy" data-src="images/zubeh%C3%B6r.jpg" alt="">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="" class="uspSectionInner">
                        <img class="lazy" data-src="images/rawMaterials-1.jpg" alt="">
