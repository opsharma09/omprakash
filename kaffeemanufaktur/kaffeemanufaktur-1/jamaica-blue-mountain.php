            ...
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    ...
                    <div class="productExcerpt">
                        <p>Jamaika – Reggae, Rastafari und Bob Marley. Traumhafte Landschaften, Zucker, Rum und Kaffee. Jamaika ist all dies und mehr. Die knapp drei Millionen Einwohner der drittgrößten Karibikinsel mit der bewegten kolonialen Vergangenheit verkörpern das karibische Lebensgefühl und produzieren einen König unter den Kaffees dieser Welt.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-Jamaica-Blue-Mountain.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/BlueMountain_falseZeichenflache-1.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="http://codesk.work/design/kaffeemanufaktur/images/BlueMountain_trueZeichenflache-1.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Jamaika ist Karibik pur. Der Champagner unter den Kaffees...</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Der Kaffee ist offizielles japanisches Kaisergetränk, nahezu 90% der Produktion wird nach Japan exportiert. Japanische Airlines servieren ihn sogar in der ersten Klasse.</p>
                        <p></p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h3>Varietät</h3>
                    <p class="mb-0">Typica und Geisha</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Herkunft</h3>
                    <p class="mb-0">Jamaika, Blue Mountain</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntemethode</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <h3>Anbauhöhe</h3>
                    <p class="mb-0">1820 m</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntezeit</h3>
                    <p class="mb-0">Juni-August, Dezember-Februar</p>
                </div>
            </div>
        </div>
        <div class="container">
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Von einer leichten Süße geprägter Körper mit zarter Säure und sehr komplexer Aromen-Struktur. Besonders anft und weich.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Ananas.png" alt="Nussig"></div><span>Ananas</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="http://codesk.work/design/kaffeemanufaktur/images/Schwarztee.png" alt="Würzig"></div><span>Tabak</span>
            </div>
        </div>
