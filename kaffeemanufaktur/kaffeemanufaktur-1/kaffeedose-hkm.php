         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Kaffeedose “Hannoversche Kaffeemanufaktur”</h2>
                     <div class="productExcerpt">
                         <p>Dekorative Kaffeedose bedruckt mit dem Logo der Hannoverschen Kaffeemanufaktur.</p>
                         <p>Fassungsvermögen: <br>Eine 250g Tüte mit Kaffee oder 500g loser Bohnenkaffee</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="http://codesk.work/design/kaffeemanufaktur/images/aap3316_edited_-_kopie.jpg" alt="">
                     </div>
                 </div>
             </div>
         </div>
