        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Hario Edelstahl Dauerfilter (01/02)</h2>
                    <div class="productExcerpt">
                        <p>Besonders nachhaltig: Weniger Müllproduktion durch den Einsatz eines Dauerfilters. Ohne die Eigenschaften des Materials bei Papierfiltern bleiben mehr Öle im Kaffee enthalten und machen den Geschmack voller und intensiver im Vergleich zum klassischen Filterkaffee. <b>Hinweis:</b> Um weniger Fineanteile in der Tasse zu haben, sollte generell eine Stufe gröber gemahlen werden.</p>
                        <ul>
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/HarioEdelstahl.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Besonders nachhaltig</h1>
                            <p>Weniger Müllproduktion durch den Einsatz eines Dauerfilters</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="col-12 back">
                        ...
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>Größe 01 (bis zu 2 Tassen)</option>
                        </select>
                    </div>
                    <!--
                    <div class="col-12 back">
