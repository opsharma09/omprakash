        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Probierpaket Espressoblends</h2>
                    <div class="productExcerpt">
                        <p>Probierpaket bestehend aus unseren drei beliebtesten Espresso-Blends. Genießen Sie das volle Spektrum von leicht und mild bis kräftig-würzig mit hohem Koffeeingehalt.</p>
                        <div><b>Im Paket enthalten:</b></div>
                        <p>Espresso Classico (80g) | Bio Espresso Maestro (80g) | Espresso Furioso (80g) <br>(Details siehe weiter unten)</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/EspressoSet.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>ESPRESSO CLASSICO <br> (80 Gramm)</h2>
                                <div>Eine Espressokomposition aus feinsten Arabicas Indiens und Südamerikas mit 20% hochwertigem indischem Robusta, die mit Ihrer Fülle und ausgeprägter Crema überrascht. Sortenrein geröstet.</div>
                                    <div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BIO ESPRESSO MAESTRO<br> (80 Gramm)</h2>
                                    <div>50% edler und kräftiger Bio Robusta aus den Bergregionen Südindiens und 50% asiatische Spitzenarabicas aus den Western Ghats Indiens. Eine unglaublich geschmackvolle und kräftige Bio-Espresso-Mischung mit viel Koffein. Perfekt abgestimmt mit 50% edlem und kräftigen Robusta aus den Bergregionen Südindiens. Kräftig vollmundiges Mundgefühl mit intensiver Cremabildung und langanhaltendem Geschmack.</div>
                                    <div>
                                        <a href="" class="button btn-white">mehr erfahren</a>
                                    </div>
                                </div>
