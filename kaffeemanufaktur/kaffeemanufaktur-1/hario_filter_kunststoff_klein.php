        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Hario Filter (klein) Kunststoff</h2>
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/3-317-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            ...
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/3-317-1.png" alt=""></div>
                            <div class="col"><span>+</span></div>
