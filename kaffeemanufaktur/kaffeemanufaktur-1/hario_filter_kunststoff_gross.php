        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Hario Filter (groß) Kunststoff</h2>
                    <div class="productExcerpt">
                        <p>Kunststofffilter von Hario zum Aufbrühen von Handfilterkaffee. <br>Die Hario V60 Modelle bringen im Vergleich zu herkömmlichen Filtern mehrere Vorteile mit sich. Jedes Detail dieses Filters ist auf eine gleichmäßige Extraktion des Kaffees ausgelegt. So sorgen die Rillen in den Wänden des Filters für eine gleichmäßige Verteilung des Wassers durch das Kaffeemehl. Das große Loch unten im Filter lässt das Wasser ungehindert durch den Filter Laufen, ohne das der Kaffee bitter wird.</p>
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="http://codesk.work/design/kaffeemanufaktur/images/3-318-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            ...
                            <div class="col"><span>+</span></div>
                            <div class="col"><img src="http://codesk.work/design/kaffeemanufaktur/images/3-318-1.png" alt=""></div><div class="col"><span>+</span></div>
