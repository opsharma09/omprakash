                            ...
                            <tbody>
                                <tr class="cart_item">
                                    ...
                                    <td class="product-total">
                                        <span class="subscription-price"><span class="woocommerce-Price-amount amount"><bdi>6,96&nbsp;<span class="woocommerce-Price-currencySymbol">€</span></bdi></span> <span class="subscription-details"> alle 3 Wochen</span></span>
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot>
                                ...
                                <tr class="woocommerce-shipping-totals shipping">
                                    ...
                                    <td data-title="Versand">
                                        <ul id="shipping_method" class="woocommerce-shipping-methods">
                                            <li>
                                                <input type="hidden" name="shipping_method[0]" data-index="0" id="shipping_method_0_flat_rate4" value="flat_rate:4" class="shipping_method"><label for="shipping_method_0_flat_rate4">Standardversand (international): <span class="woocommerce-Price-amount amount"><bdi>9,90&nbsp;<span class="woocommerce-Price-currencySymbol">€</span></bdi></span></label>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <tr class="shipping recurring-total 2020_11_13_every_3rd_week">
                                    ...
                                    <td data-title="Shipping">
                                        <ul id="shipping_method_2020_11_13_every_3rd_week">
                                            ...
                                            <li>
                                                <input type="radio" value="flat_rate:9" class=""><label for="shipping_method_2020_11_13_every_3rd_week_0_flat_rate9">Versandkostenpauschale</label>
                                            </li>
                                        </ul>
