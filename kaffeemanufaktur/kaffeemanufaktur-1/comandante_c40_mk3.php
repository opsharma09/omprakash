...
<body>
    ...
    <div id="singleProductCoffeeIntroSection" class="singleProductIntroSection packshotAnimationReferenceContainer">
        <div class="singleProductV2Background">
            <div style="background-image: url('http://codesk.work/design/kaffeemanufaktur/images/untitled-1-Main-Foto-1920-6@2x.jpg'); filter: blur(0px);" class="backgroundBlur"></div>
        </div>
