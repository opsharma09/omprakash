        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Cupping Löffel</h2>
                    <div class="productExcerpt">
                        <p>Unser Cupping Löffel aus Edelstahl ist ein formschönes Hilfsmittel für die Verkostung von Kaffee.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/10_scu_coffee_cupping_300x300.png" alt="">
                    </div>
                </div>
            </div>
        </div>
