         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Thermometer “analog”</h2>
                     <div class="productExcerpt">
                         <p>Edelstahl-Eintauchthermometer, mit dem präzise verfolgt werden kann, bei welcher Temperatur sich die Milch befindet und wann sie zu heiß wird. Besonders hilfreich beim Aufschäumen. Mit verstellbarem Befestigungsclip - für jedes Milchkännchen geeignet. <br>Maße: Durchmesser x Länge: Ø 4 cm x 13 cm <br>Material: Edelstahl <br> Pflege: Bitte nur feucht abwischen, nicht in die Spülmaschine geben.</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="http://codesk.work/design/kaffeemanufaktur/images/12_xth_milchschaum_thermometer_300x300.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>Edelstahl Eintauchthermometer</h2>
                         </div>
                     </div>
                 </div>
             </div>
