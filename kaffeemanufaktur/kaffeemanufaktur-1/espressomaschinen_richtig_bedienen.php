         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Espressomaschinen – richtig bedienen</h2>
                     <div class="productExcerpt">
                         <p>Sie sind Kaffeejunkie und wollen zu Hause perfekten Espresso oder Cappuccino genießen. Doch welche Espressomaschine ist die richtige für Sie und Ihre ganz individuellen Bedürfnisse? <br>
                             In diesem kompakten Nachschlagewerk finden Sie die Antwort auf diese und viele weitere Fragen. Von Hebelmaschine bis Multiboiler:
                             Welches Modell wird Ihren Ansprüchen gerecht? <br>
                             Einstellung und Handhabung: <br>
                             Wie stellen Sie die Maschine auf den jeweiligen Kaffee ein? <br>
                             Helle oder dunkle Röstung: Welche Bohnen treffen Ihren Geschmack? <br>
                             Mahlwerke: Warum ist eine gute Kaffeemühle genauso wichtig wie die Espressomaschine selbst? <br>
                             Darüber hinaus finden Sie wertvolle Tipps zu Platzbedarf, Wartung, Reinigung und Pflege sowie Maschinenbeschreibungen. Ob Vieltrinker oder Gelegenheitsgenießer, Espressomaschinen ist ein Buch für all jene, die bei der Zubereitung von Espresso oder Cappuccino nichts dem Zufall überlassen wollen. <br>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h1>Für Kaffeejunkies</h1>
                             <p>Bei der Zubereitung von Espresso oder Cappuccino nichts dem Zufall überlassen</p>
                         </div>
                     </div>
                 </div>
             </div>
