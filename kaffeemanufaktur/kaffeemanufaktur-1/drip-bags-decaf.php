        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Drip Coffee Box: Bio Entkoff.</h2>
                    <div class="productExcerpt">
                        <p>Drip-Kaffee Box bestehend aus 10 Filterpäckchen. Mit diesen 10 kleinen Genussmomenten können Sie unseren entkoffeinierten Klassiker erkunden. Unser Bio Arabica entkoffeiniert ist ein wunderbar, würzig-aromatischer Arabica mit mittelvollem Körper und samtigem Abgang. Mit Hilfe eines sehr aufwendigen Verfahrens wird dieser Kaffee schonend von seinem Koffein gelöst.</p>
                        <div><b>Im Paket enthalten:</b></div>
                        <p>10x Bio Arabica (entkoffeiniert)</p>
                    ...
                    <div class="col-md-10 m-auto">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-5 mx-auto">
                                <a href="">
                                    <div class="hoverZoom">
                                        <img src="http://codesk.work/design/kaffeemanufaktur/images/Packshots-Abstrakt-neu-Okt.-2018Bio-Arabica-Entkoffeiniert.png" alt="">
                                    </div>
                                </a>
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BIO ARABICA (ENTKOFFEINIERT)<br> (10 Beutel)</h2>
                                    <div>Unser Bio Arabica entkoffeiniert ist ein wunderbar, würzig-aromatischer Arabica mit mittelvollem Körper und samtigem Abgang. Mit Hilfe eines sehr aufwendigen Verfahrens wird dieser Kaffee von seinem Koffein gelöst.</div>
                                    <div>
