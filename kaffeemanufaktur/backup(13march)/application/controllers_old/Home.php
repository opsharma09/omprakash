...
class Home extends CI_Controller {
    ...
    {
        // echo ucfirst($id);die();
        $main_cat=$this->db->query("select * from product_under_category where id = 'ucfirst($id)'")->row_array();  
       echo $this->db->last_query();die();
        ...
        $data['products']= $this->Common->select_data('products','*',array('category'=>$id));
