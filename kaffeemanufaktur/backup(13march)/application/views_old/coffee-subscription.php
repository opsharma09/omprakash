...
<body>
    ...
    <section class="inner_content_banner">
        <img class="lazy" data-src="images/subscription.jpg" alt="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="left_subscription">
                        ...
                        <img src="images/subscription-img.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="right_subscription">
                        <div class="feature_img_box">
                            <div class="img_number">
                                <img src="images/free-img.png" alt="">
                                <span>1</span>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="individual_coffee_box" id="coffee_one">
                        <img src="images/coffee_one.png" alt="">
                ...
                <div class="col-md-4">
                    <div class="individual_coffee_box" id="coffee_two">
                        <img src="images/coffee_two.png" alt="">
                ...
                <div class="col-md-4">
                    <div class="individual_coffee_box" id="coffee_three">
                        <img src="images/coffee_three.png" alt="">
