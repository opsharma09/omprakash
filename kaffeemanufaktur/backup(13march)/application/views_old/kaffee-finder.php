...
<body>
    ...
    <div id="flavorButtons">
        <div class="container">
            <div class="coffeeFinderPage buttonpage">
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/syphon.svg" alt=""> <span>Syphon</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/Siebtr%C3%A4ger.svg" alt=""><span>Siebträger</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/Vollautomat.svg" alt=""><span>Vollautomat</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/herdkanne.svg" alt=""><span>Herdkanne</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/french-press.svg" alt=""> <span>French Press</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/filter.svg" alt=""> <span>Filder</span></div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="slider">
            ...
            <div class="coffeeFinderPage buttonpage">
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/map.svg" alt=""> <span>Syphon</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/map.svg" alt=""><span>Siebträger</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/map.svg" alt=""><span>Vollautomat</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/map.svg" alt=""><span>Herdkanne</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/map.svg" alt=""> <span>French Press</span></div>
                <div class="coffeefinderbutton"><img src="<?= base_url() ?>public/images/map.svg" alt=""> <span>Filder</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="product_wrapper">
        <div class="products text-center">
            <div class="container">
                <div class="row">
                    <?php foreach($productsT as $value){?>
