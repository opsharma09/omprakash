        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">  <!--menu-open -->
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'products/admin_products' ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Products</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'products/variation' ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Products Variations</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'products/product_type' ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Product type</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'products/product_availability' ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
