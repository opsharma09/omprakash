                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <form action="register" class="registration" method="post" id="registration-form" >
                                <div class="form-row">
...
<!--                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="submit" class="form-control" value="Register" id="register_butt" disabled="">
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<!--lowerSection ended.-->
    ...
    $('.custom-control-input').change(function () {
        if ($(this).prop("checked")) {
            $('#register_butt').prop('disabled',false);
            return;
        }$('#register_butt').prop('disabled',true);
    });
