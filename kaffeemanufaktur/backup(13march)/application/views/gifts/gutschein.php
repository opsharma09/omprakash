...
<body>
                ...
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <div>
                        ...
                        <div class="productExcerpt">
                            <p>Sie suchen ein Geschenk für Kaffeeliebhaber und können sich nicht entscheiden?
                                <br>Schenken Sie einen unserer Gutscheine - einlösbar in unseren Filialen in der
                                Wunstorfer Straße 33 in Hannover-Limmer und in der Dorfstraße 17 in Burgdorf-Heeßel.</p>
                        </div>
                    </div>
                </div>
                <div class="packshot">
    ...
    <div id="accessoriesIntroSectionWrapper">
        <div class="hasSimpleTextArea">
            <div id="accessoriesIntroSectionTopDecoration"
        ...
        <div class="product_selector_inner">
                ...
                <div class="form-row">
                    <div class="col-12 back">
                        ...
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>10,00 &euro; - 100,00 &euro;</option>
                        </select>
                    </div>
                    <div class="col-12 back">
            ...
            <div class="payment-gateway text-center">
                <div class="payment d-inline-block">
                    <img src="<?=base_url()?>public/images/paypal-min.svg" alt="">
