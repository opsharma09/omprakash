                    ...
                    <div class="categories">
                        ...
                        <div class="categoryNavLevel">
                            <!-- <?php foreach ($maincategory as $key => $value) {?>
                                <a href="<?= base_url('produkt-kategorie/'.com_slugify($value['e_name'])) ?>" <?php if($categories == $value['name']){?>class="activeCategory"<?php } ?>><?=$value['name']?></a> |
                            ...
                            <?php
                             ...
                             foreach ($category_array as $key=> $cat) {?>
                               <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify($cat)) ?>"<?php if($key==2){ echo 'class="activeCategory"';}?>><?=$cat?></a> |
