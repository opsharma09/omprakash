        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Sie haben das Recht, diesen Vertrag innerhalb von 14 Tagen ohne Angaben von Gründen zu widerrufen.</p>
                    <p>Die Widerrufsfrist beträgt vierzehn Tage ab dem Tag,</p>
                    <p> a) im Falle eines Kaufvertrags: an dem Sie oder ein von Ihnen benannter Dritter, der nicht der Beförderer ist, die Waren in Besitz genommen hast bzw. hat.<br> b) im Falle eines Vertrags über mehrere Waren, die Sie im Rahmen einer einheitlichen Bestellung bestellt haben und die getrennt geliefert werden: an dem Sie oder ein von Ihnen benannter Dritter, der nicht der Beförderer ist, die letzte Ware in Besitz genommen haben bzw. hat. Um Ihr Widerrufsrecht auszuüben, müssen Sie uns mittels einer eindeutigen Erklärung (z. B. ein mit der Post versandter Brief, Telefax oder E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Sie können dafür <a target="_blank" href="/wp-content/uploads/widerrufsformular.pdf">das beigefügte Muster-Widerrufsformular</a> verwenden, das jedoch nicht vorgeschrieben ist.</p>
                    ...
                    <p>Sie haben die Waren unverzüglich und in jedem Fall spätestens binnen vierzehn Tagen ab dem Tag, an dem Sie uns über den Widerruf dieses Vertrags unterrichtet haben, an uns zurückzusenden oder zu übergeben. Die Frist ist gewahrt, wenn Sie die Waren vor Ablauf der Frist von vierzehn Tagen absenden. Sie tragen die unmittelbaren Kosten der Rücksendung der Waren.</p>
                    <p>Sie müssen für einen etwaigen Wertverlust der Waren nur aufkommen, wenn dieser Wertverlust auf einen zur Prüfung der Beschaffenheit, Eigenschaften und Funktionsweise der Waren nicht notwendigen Umgang mit ihnen zurückzuführen ist.</p>
                    <p><a target="_blank" href="/wp-content/uploads/widerrufsformular.pdf"><strong style="color： black;">Muster-Widerrufsformular</strong></a></p>
                </div>
            </div>
        </div>
    </div>
