          ...
          <div class="row">
            <div class="col-sm-8"><br>
                <div class="form-group">
                  ...
                  <img id="image" height="100px" style="padding-left:10px" src="http://codesk.work/dev/kaffeemanufaktur/<?= $category_info[0]['image'] ?>"/><br>
                  <label>Product Image 1</label>
                  <input type="file" name="image1" class="form-control" onchange="readURL1(this);">
                  <img id="image1" height="100px" style="padding-left:10px" src="http://codesk.work/dev/kaffeemanufaktur/<?= $category_info[0]['image1'] ?>"/><br>
