...
class Products extends CI_Controller
{
    ...
    public function product($id){
           ...
           // var_dump($availability);
                ...
                if($product_info[0]['category']==19 || $product_info[0]['category']==20 || $subcategory[0]['is_package']=='Y'){
    ...
    public function subcategory_option1(){
        ...
        $html1 = '';
        $is_package ='';
        $html1 .= '<div class="col-sm-6"><input type="checkbox" class="show_sub_category" value="0" id="show_sub_category0" name="show_sub_category[]"><label for="show_sub_category0">All subcategory</label></div>';
