                    ...
                    <div class="categories">
                        ...
                        <div class="categoryNavLevel">
                            ...
                            <!-- <?php foreach ($pcategory as $cat) {?>
                               <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify($cat['name'])) ?>"<?php if($cat['name']=='Espresso'){ echo 'class="activeCategory"';}?>><?=$cat['name']?></a> |
                            <?php } ?> <a href="<?= base_url() ?>">Alle Produkte</a><br><br> -->
                            <?php
                             ...
                             foreach ($category_array as $cat) {?>
                               <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify($cat)) ?>"<?php if($cat=='Espresso'){ echo 'class="activeCategory"';}?>><?=$cat?></a> |
