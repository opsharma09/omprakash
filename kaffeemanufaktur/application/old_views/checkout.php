                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <select name="" id="" class="js-example-basic-single" id="country" name="country" style="width:100%" >
                                            ...
                                            <option value="DK" <?php if($bill_address->country == 'DK'){echo 'selected';}?>>Dänemark</option>
                                            ...
                                            <option value="RO" <?php if($bill_address->country == 'RO'){echo 'selected';}?>>Rumänien</option>
                                            ...
                                            <option value="AT" <?php if($bill_address->country == 'AT'){echo 'selected';}?>>Österreich</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" placeholder="Straße und Hausnummer*" id="street" name="street" class="form-control" required="" value="<?=$bill_address->street?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div id="delivery_div" >
                                        ...
                                        <div class="form-group">
                                            <select name="" id="" class="js-example-basic-single" name="d_country" style="width:100%" >
                                                ...
                                                <option value="DE" selected="selected">Deutschland</option>
                                                <option value="DK" <?php if($del_address->country == 'DK'){echo 'selected';}?>>Dänemark</option>
                                                ...
                                                <option value="RO" <?php if($del_address->country == 'RO'){echo 'selected';}?>>Rumänien</option>
                                                ...
                                                <option value="AT" <?php if($del_address->country == 'AT'){echo 'selected';}?>>Österreich</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" placeholder="Straße und Hausnummer*" id="d_street" name="d_street" class="form-control" value="<?=$del_address->first_name?>">
                                        </div>
                                        <div class="form-group">
