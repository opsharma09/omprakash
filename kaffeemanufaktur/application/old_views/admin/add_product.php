        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-sm-8">
              ...
              <div class="form-group row div_hide" >
                <div class="col-sm-4" style="text-align:right">
                  <label>Coffee Finder</label>
                </div>
                <div class="col-sm-8">
                  <div class="row">
                    <div class="col-sm-3">
                      <input type="checkbox" value="coffee_drink" id="coffee_drink" name="coffee_drink>">
                      <label for="coffee_drink">Coffee Drink Type</label>
                    </div>
                    <div class="col-sm-3">
                      <input type="checkbox" value="coffee_taste" id="coffee_taste" name="coffee_taste>">
                      <label for="coffee_taste">Taste in coffee</label>
                    </div>
                  </div>
                </div>
              </div>
