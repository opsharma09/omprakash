...
class Products extends CI_Controller
{
    ...
    public function add_product()
    {
            ...
            if($this->input->method()=='post')
            {
                ...
                $data['product_details'] = $this->Common->join_mult_table('availability',
                 ['product_variation'],
                 ['availability.variation_id=product_variation.id'],[],
                $projection = 'availability.*,product_variation.name as product_variation_name', $distinct = '', $limit = '', $offset = 0,$join_type='left');
    ...
    {   
        ...
        else 
        {
            ...
            $data['availability']=$this->Common->select_data('availability','*');
            $product_details = $this->Common->join_mult_table('availability',
                 ['product_variation'],
                 ['availability.variation_id=product_variation.id'],['product_id =$id'],
                $projection = 'availability.*,product_variation.name as product_variation_name', $distinct = '', $limit = '', $offset = 0,$join_type='left');
            // $product_details=$this->Common->select_data('availability','variation_id',array('product_id'=>$id));
            $product_variation = array();
            foreach ($product_details as $key => $value) {
               array_push($product_variation, $value['variation_id']);
            }
    ...
    public function product($id){
            ...
            $data['product_details']=$this->Common->select_data('product_details','id,type,availability_id',array('product_id'=>$id));
            foreach($data['product_details'] as $key=>$mydata){
                $data['product_details'][$key]['availability']=$this->Common->select_data('availability','*',array('id'=>$mydata['availability_id']));
            }
    ...
    public function product_availability()
    {
            ...
            if($this->input->method()=='post')
            {
                ...
                $data['all_data'] = $this->Common->join_mult_table('availability',
                 ['product_variation'],
                 ['availability.variation_id=product_variation.id'],[],
                $projection = 'availability.*,product_variation.name as product_type', $distinct = '', $limit = '', $offset = 0,$join_type='left');
                $this->load->view('admin/includes/header',$data);
