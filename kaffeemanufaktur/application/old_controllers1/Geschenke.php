...
class Geschenke extends CI_Controller {
    ...
    {
        $id=$this->Common->select_data('product_category','id',array('name'=>'geschenke'));
    ...
    public function geschenke_new($idd)
    {
        $limit=12;
        $total_pages=0;
        $i=0;
    ...
    public function geschenke_sub($idd)
    {
        $limit=12;
        $total_pages=0;
        $i=0;
