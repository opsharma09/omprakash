...
$sub_category_result = $category1_query->result();
foreach ($sub_category_result as $row) {
	$route['produkt-kategorie/kaffee-espresso/'.'kaffee'.'/'.slugify($row->e_name)] = 'kaffee/kaffee_sub/'.$row->id;
}
foreach ($sub_category_result as $row) {
	$route['produkt-kategorie/kaffee-espresso/'.'espresso'.'/'.slugify($row->e_name)] = 'espresso/espresso_sub/'.$row->id;
}
foreach ($sub_category_result as $row) {
	$route['produkt-kategorie/zubehoer'.'/'.slugify($row->e_name)] = 'home/produkt_sub/'.$row->id;
}
foreach ($sub_category_result as $row) {
	$route['produkt-kategorie/kaffee-espresso/kaffee/sortenreine_kaffees/'.slugify($row->e_name)] = 'kaffee/kaffee_sub/'.$row->id;
}
...
$route['mein-account/order-detail/(:any)'] = 'order/order_detail/order/$1';
$route['mein-account/subscriptions-detail/(:any)'] = 'order/order_detail/subscriptions/$1';
...
$route['mein-account/change-password'] = 'users/user_profile/change_password';
$route['produkt-kategorie/geschenke'] = 'home/geschenke';
$route['produkt-kategorie/geschenke/geschenkideen'] = 'home/geschenkideen';
$route['veranstaltungen'] = 'home/veranstaltungen';
$route['baristakurs'] = 'home/genussreise';
$route['genussreise'] = 'home/genussreise';
$route['produkt/gutschein?(:any)'] = 'home/gutschein';
$route['produkt-kategorie/gutscheine'] = 'home/gutschein';
$route['order/success/(:any)'] = 'order/payment_success/$1';
...
$route['firmenkunden'] = 'home/firmenkunden';
...
$route['subscription-detail'] = 'home/subscription_detail';
$route['kontakt'] = 'home/kontakt';
$route['forgot-password'] = 'home/forgot_password';
$route['login/forgot-password'] = 'login/forgot_password';
$route['login/reset-password'] = 'login/save_password';
$route['agb'] = 'home/terms';
$route['widerrufsbelehrung'] = 'home/policy';
$route['datenschutz'] = 'home/data_protection';
$route['newsletter/subscribe'] = 'home/subscribe';
$route['cancel'] = 'order/cancel_by_user/';
$route['error/(:any)'] = 'order/error/$1';
// $route['roestung/#rohkaffee'] = 'home/rohkaffee';
// $route['oestung/#roestPhilosophie'] = 'homer/oestPhilosophie';
// $route['oestung/#roestmeister'] = 'home/roestmeister';
// $route['roestung/#frische'] = 'home/frische';
