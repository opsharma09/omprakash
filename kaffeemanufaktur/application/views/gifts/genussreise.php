...
<body>
                            ...
                            <form method="post" action="<?=base_url('events/save_events')?>">
                                ...
                                <div class="bookly-form-box step2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 clearfix">
                                            <button class="btn float-left" type="button" id="zuruck1">Zurück</button>
                                            <!-- <button class="btn float-right" type="submit">WEITER</button> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="bookly-form-box step3">
                                    <p>Sie wählten eine Reservierung von <b class="event_type_name">Baristakurs</b> mit <b id="event_type_name2">HKM - Baristakurs</b> in der Zeit <b id="event_time">13:30</b> Uhr am <b id="event_date">27. September 2020</b>. Das Entgelt für den Service beträgt <b>€ <span id="event_price">99,00</span></b>. </sapn><br>Bitte tragen Sie Ihre Angaben in das Formular unten ein, um mit der Buchung fortzufahren.</p>
                                    <?php if(!$this->session->userdata('user')){ ?><h3 class='text-center' style='font-size: 30px; line-height: .9; margin: -8px 0 30px;'>Have you an account ? <a href="<?=base_url('login')?>"> Click Here</a></h3><?php } ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="mitteilung" rows="3" class="form-control" name="message"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-12 clearfix">
                                            <button class="btn float-left" type="button"  id="zuruck2">Zurück</button>
                                            <button class="btn float-right" type="submit">WEITER</button>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#zuruck1').on('click', function(e){ 
             e.preventDefault();
            $('.step1').show();
            $('.step2').hide();
            $('.step3').hide();
            $('.bookly-progress-tracker .zeit').removeClass('active');
        });
        $('#zuruck2').on('click', function(e){ 
            ...
            $('.step2').show();
            $('.step3').hide();
            $('.bookly-progress-tracker .details').removeClass('active');
        });
