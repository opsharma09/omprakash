            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="switch_cancel">
                        <h5>Switch it up at any time. Cancel at any time.</h5> <a href="<?=base_url('subscription-detail')?>" class="btn-white"><span class="fa fa-calendar-alt"></span> Configure your Coffee-sub! ›</a>
                    </div>
                </div>
            </div>
        </div>
