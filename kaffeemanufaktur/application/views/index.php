...
<body>
    ...
    <div class="banner">
        ...
        <div class="content-overlay">
            ...
            <a href="<?=base_url('subscription')?>" class="btn-white">Jetzt bestellen</a>
        </div>
    </div>
    <!--banner ended.-->
    <!--features started.-->
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="position-relative">
                        ...
                        <div class="content-overlay">
                            <h4>FILTERKAFFEE</h4>
                            <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify('kaffee')) ?>" class="btn-white">Jetzt bestellen</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="position-relative">
                        ...
                        <div class="content-overlay">
                            <h4>ESPRESSO</h4>
                            <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify('espresso')) ?>" class="btn-white">Jetzt bestellen</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="position-relative">
                        ...
                        <div class="content-overlay">
                            <h4>ZUBEHÖR</h4>
                            <a href="<?= base_url('produkt-kategorie/'.com_slugify('zubehoer')) ?>" class="btn-white">Jetzt bestellen</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="position-relative">
                        ...
                        <div class="content-overlay">
                            ...
                            <a href="<?= base_url('produkt-kategorie/kaffee-espresso/kaffee/probierpakete')?>" class="btn-white">Jetzt bestellen</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="position-relative">
                        ...
                        <div class="content-overlay">
                            ...
                            <a href="<?= base_url('produkt-kategorie/kaffee-espresso/kaffee/drip-bags')?>" class="btn-white">Jetzt bestellen</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="products text-center">
            <div class="container">
                <div class="row">
                    ...
                    <?php
                     $price_array = array(); foreach($pproducts as $value){
                        ...
                        <div class="product">
                            <a href="<?=base_url('produkt/'.com_slugify($value['e_name']))?>" class="d-block">
                                ...
                                <div class="categoryThumbnailsContainer">
                                    ...
                                    <?php if(!empty($value['body']) && !empty($value['acid']) && !empty($value['aftertaste'])){?>
                                    <span class="form-row">
                                        <span class="col-6">
...
<!--our_accessories ended.-->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="<?=base_url('roestung/#rohkaffee')?>" class="uspSectionInner">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="<?=base_url('roestung/#roestPhilosophie')?>" class="uspSectionInner">
                        <img class="lazy" data-src="<?= base_url() ?>public/images/rawMaterials-2.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="<?=base_url('roestung/#roestmeister')?>" class="uspSectionInner">
                        <img class="lazy" data-src="<?= base_url() ?>public/images/rawMaterials-3.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="<?=base_url('roestung/#frische')?>" class="uspSectionInner">
                        <img class="lazy" data-src="<?= base_url() ?>public/images/rawMaterials-4.jpg" alt="">
    ...
    <seciton class="coffee_solutions">
        ...
        <div class="img-wrapper">
            <img class="lazy" data-src="<?=base_url()?>public/images/gossip.jpg" alt="">
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-md-6">
                    <div class="left">
                        ...
                        <a href="<?=base_url('firmenkunden')?>" class="btn-white">mehr erfahren</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="right">
                        ...
                        <a href="<?=base_url('gastronomie')?>" class="btn-white">mehr erfahren</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <img class="lazy" data-src="<?=base_url()?>public/images/partner.svg" alt="">
                </div>
            </div>
        </div>
    </section>
