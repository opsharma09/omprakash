...
<body>
    ...
    <div id="helperBox">
        ...
        <div class="product_selector_inner">
            <form action="#">
                <div class="form-row">
                    <div class="col-12 back" <?php if($product[0]['category']==19 || $product[0]['category']==20 || $product[0]['category']==21 || $is_package == 'Y'){?>style="display: none" <?php } ?>>
                    ...
                    <div class="col-12 back">
                        <?php if($product[0]['category']==19 || $product[0]['category']==20 || $product[0]['category']==21 || $is_package == 'Y'){
                            if (!empty($product_details)) {
                                # code...
                        ...
                        <select name="" id="menge" class="form-control" onchange="resetme();check_quantity()">
                            ...
                            <option value="<?=$value['id']?>" price="<?=$value['price']?>"><?=str_replace('.', ',', $value['size'])?></option>
                            <?php } }?>
                        </select>
                    ...
                    <div class="col-12">
                        <div class="single_variable_wrap">
                            ...
                            <div class="customPriceTag">
                                <p id="product_price"><?php if(sizeof(array_unique($price_array))>1){echo str_replace('.', ',', $min).'€ - '.str_replace('.', ',', $max).'€';}else{
                                echo $min.' €';
                              }?></p>
            ...
            for (i = 0; i < obj.length; i = i + 1) {
                if (i == 0) {
                    $('#menge').append("<option value='" + obj[i].id + "' price='" + obj[i].price +
                        "' selected>" + obj[i].size.replace(".",",") + "</option>");
                    check_quantity();
                } else {
                    $('#menge').append("<option value='" + obj[i].id + "' price='" + obj[i].price + "'>" +
                        obj[i].size.replace(".",",") + "</option>");
                }
            }
    ...
    if ($(window).width() >= 992) {
        ...
        function check_quantity() {
            ...
            var main = q * p;
            $('#product_price').text(main.toFixed(2).replace(".",",") + ' €');
        ...
        function add_to_cart() {
            ...
            if (idd != '' || pcat==19 || pcat==21 || pcat==20 || is_package== 'Y') {
