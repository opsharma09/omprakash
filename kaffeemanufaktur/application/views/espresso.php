                    ...
                    <div class="categories">
                        ...
                        <div class="categoryNavLevel">
                            ...
                            <?php foreach ($psubcategory as $cat) {?>
                               <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify('espresso')).'/'.com_slugify($cat['e_name']) ?>"<?php if($cat['name']==$option){ echo 'class="activeCategory"';}?>><?=$cat['name']?></a> |
