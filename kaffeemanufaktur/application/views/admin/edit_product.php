      ...
      <div class="card p-3">
         ...
         <div class="border rounded p-3 pt-5">
            <form action="<?php echo base_url().'products/edit_product/'.$category_info[0]['id'] ?>"
               class="database_operations" enctype="multipart/form-data" id="product_form" method="post">
               <div class="row">
                  <div class="col-sm-8 m-auto">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           ...
                           <img id="image" height="100px" src="<?= base_url()?><?=$category_info[0]['image1']?>"  style="display:flex" />
                           <input type="file" name="image" class="form-control" placeholder="Enter Product Image" style="width:1%" onchange="readURL1(this);" value="<?=$category_info[0]['image1']?>">
                              </div>
                        </div>
                     </div>
                     <div class="form-group row">
                        ...
                        <?php  
                        $category_id = $category_info[0]['category'];
                        $id = $category_info[0]['id'];
                        ...
                        $jsubcat =$this->db->query("select subcategory_id from product_join_category where product_id= $id AND is_delete=0")->result();
                        $arr = array();
                        if(!empty($jsubcat)){
                        foreach ($jsubcat as $key => $value) {
                          array_push($arr, $value->subcategory_id);
                        }}
                         foreach($all_sub_category1 as $cat){
                          ...
                          ?>
                          <div class="col-sm-6">
                            <input type="checkbox" value="<?=$cat['id']?>" id="show_sub_category<?= $cat['id']; ?>" name="show_sub_category<?= $cat['id']; ?>" <?php if(in_array($cat['id'],$arr)){ echo 'checked';}?>>
                        ...
                        <div class="col-sm-9">
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 ...
                                 <label for="suitable<?= $cat['id']; ?>"><img style="width: 30px;height: 30px" title="<?=$cat['name']?>"src="<?= base_url()?><?=$cat['image']?>" />(<?=$cat['name']?>)</label>
                              </div>
                              <?php } } ?>
                           </div>
                        </div>
                    ...
                    <div class="form-group row div_hide" >
                      ...
                      <div class="col-sm-9">
                        <div class="row">
                          <div class="col-sm-6">
                            <input type="checkbox"<?php if (in_array("Kraeftig", $coffee_drink)){ echo 'checked';}?> value="Kraeftig" id="Kraeftig" name="coffee_drink[]">
                            <label for="Kraeftig">Kräftig</label>
                          </div>
                          <div class="col-sm-6">
                            <input type="checkbox"<?php if (in_array("mild", $coffee_drink)){ echo 'checked';}?> value="mild" id="mild" name="coffee_drink[]">
                      ...
                      <div class="col-sm-9">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <label for="curious">Etwas Spezielle</label>
                          </div>
                          <div class="col-sm-6">
                              ...
                              <div class="col-sm-6">
                                 <select class="form-control" name="body_rating">
                                    ...
                                    <option
                                       ...
                                       value="0">0</option>
                                       <option
                                       <?php if($category_info[0]['body_rating']==0.5){echo 'selected';}?>
                              ...
                              <div class="col-sm-6">
                                 <select class="form-control" name="acid_rating">
                                    ...
                                    <option
                                       ...
                                       value="0">0</option>
                                       <option
                                       <?php if($category_info[0]['acid_rating']==0.5){echo 'selected';}?>
                                       value=".5">.5</option>
                                    <option
                              ...
                              <div class="col-sm-6">
                                 <select class="form-control" name="aftertaste_rating">
                                    ...
                                    <option
                                       ...
                                       value="0">0</option>
                                       <option
                                       <?php if($category_info[0]['aftertaste_rating']==0.5){echo 'selected';}?>
                                       value=".5">.5</option>
                                    <option
                  ...
                  <div class="col-sm-12">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <textarea  class="form-control" name="product_details" rows="30"><?=$category_info[0]['product_detail']?></textarea>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-12">
