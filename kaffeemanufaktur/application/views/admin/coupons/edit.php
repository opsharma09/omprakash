                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row  showcategory_select">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6"><input type="checkbox"  onclick="select_subcat(this)" class="show_sub_category" value="0" id="show_sub_category0" <?php if(in_array(0,$offer_sub_category)){ echo 'checked';}?> name="show_sub_category[]"><label for="show_sub_category0">All subcategory</label></div>
