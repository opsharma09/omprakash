            ...
            <?php 
              if(isset($success_msg)){
                if(!empty($success_msg)){
                  echo '<p class="statusMsg" style="color:green">'.$success_msg.'</p>';
                }
    ...
    <div class="modal-content ">
        <form action="<?=base_url("coupons/coupons_bulk_import")?>" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <h5 class="text-danger" id="import_error" style="color: red"><?php echo form_error('file','<p class="help-block">','</p>'); ?></h5>
