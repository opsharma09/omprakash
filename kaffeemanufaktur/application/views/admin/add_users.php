        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <input type="text" name="first_name" required="required" class="form-control" placeholder="Enter First Name">
              <label>Enter Last name</label>
              <input type="text" name="last_name" required="required" class="form-control" placeholder="Enter Last Name">
              <label>Enter Mobile Number</label>
              <input type="text" name="phone_no" required="required" class="form-control" placeholder="Enter Mobile number">
              ...
              <label>Address</label>
              <textarea name="address" required="required" class="form-control" placeholder="Enter address"></textarea>
