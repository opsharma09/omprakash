                    ...
                    <div class="categories">
                        ...
                        <div class="categoryNavLevel">
                            <?php
                                ...
                                $country_array =array("Sortenrein Asien","Sortenrein Amerika","Sortenrein Afrika");
                            ...
                            <?php } ?> <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify('kaffee')) ?>">Alle Produkte</a><br><br>
                            <?php  if($this->uri->segment(4)=='sortenreine_kaffees'){  foreach ($country_array as $cat) {
                               $var =  explode(' ', $cat);
                                ?>
                               <a href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify('kaffee')).'/sortenreine_kaffees/'.com_slugify($cat) ?>" <?php if($var[1]==$option){ echo 'class="activeCategory"';}?>><?=$var[1]?></a> |
                        ...
                        <div class="product">
                            <a href="<?=base_url('produkt/'.com_slugify($value['e_name']))?>" class="d-block">
                                ...
                                <div class="desc">
                                    ...
                                    <span class="price"><?php if(sizeof(array_unique($price_array))>1){echo $min.'€ - '.$max.'€';}else{
                                echo $min.'€';
                              }?></span>
                                </div>
