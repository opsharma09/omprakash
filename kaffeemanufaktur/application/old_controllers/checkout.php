                            ...
                            <div class="col-lg-6">
                                ...
                                <div id="delivery_div">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Anmerkungen zu Ihrer Bestellung, z.B. besondere Hinweise für die Lieferung."  name="ordering_information" rows="2" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        <div class="form-group">
