      ...
      <section class="content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url().'products/add_product/' ?>" class="database_operations" enctype="multipart/form-data"  id="product_form">
          <div class="row">
            <div class="col-sm-8">
              ...
              <div class="form-group row div_hide">
                ...
                <?php foreach($product_equipment as $cat){ 
                  ...
                  <div class="col-sm-4">
                    ...
                    <label for="suitable<?= $cat['id']; ?>"><img style="width: 30px;height: 30px" title="<?=$cat['name']?>" src="<?= base_url()?><?=$cat['image']?>" /></label>
                  </div>
                <?php } } ?> 
                </div>
                </div> 
                ...
                <?php foreach($product_equipment as $cat){
                  ...
                  ?>
                      <div class="col-sm-4">
                        ...
                        <label for="country<?= $cat['id']; ?>"><img style="width: 30px;height: 30px" title="<?=$cat['name']?>" src="<?= base_url()?><?=$cat['image']?>" /></label>
                      </div>
                <?php } } ?>  
                    </div>
                  </div>
              ...
              <div class="form-group row div_hide" >
                ...
                <div class="col-sm-8">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="checkbox" value="black" id="black" name="coffee_drink[]">
                      <label for="black">Black</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="checkbox" value="milk" id="milk" name="coffee_drink[]">
                      <label for="milk">With milk</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="checkbox" value="milksugar" id="milksugar" name="coffee_drink[]">
                      <label for="milksugar">With milk and sugar</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="checkbox" value="decaf" id="decaf" name="coffee_drink[]">
              ...
              <div class="form-group row div_hide" >
                ...
                <div class="col-sm-8">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <input type="checkbox" value="adventurous" id="adventurous" name="coffee_taste[]">
              ...
              <div class="form-group row div_hide">
                ...
                <div class="form-group row div_hide">
                  ...
                  <?php foreach($product_equipment as $cat){
                    ...
                    <div class="col-sm-4">
                      ...
                      <label for="taste<?= $cat['id']; ?>"><img style="width: 30px;height: 30px" title="<?=$cat['name']?>" src="<?= base_url()?><?=$cat['image']?>" /><?=$cat['name']?></label>
                    </div>
                  <?php } } ?>
                  </div>
                  </div>  
                ...
                <div class="col-sm-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <textarea name="product_details" id="product_details"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-sm-8">
    ...
    $.ajax({
            ...
            success: function (response) {
                if(response =='ok'){
                  ...
                  $('#error_name').html('<span style="color:red">Slug Name is already exist. </span>');
                }else{
                  $('#product_form').submit();
                }
            }
