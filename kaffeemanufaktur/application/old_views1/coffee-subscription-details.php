                            ...
                            <div class="row">
                                    ...
                                    <div class="wizard" style="border-top: 2px solid black;padding-top: 0px">
                                        <div class="wizard-inner">
                                            <ul class="nav nav-tabs" role="tablist" style="border-bottom: none">
                                                <div class="col-lg-6 wahlen1">
                                                    <li role="presentation" class="active">
                                                        <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" class="wahlen">
                                                            <span>Kaffee wählen</span>
                                                        </a>
                                                    </li>
                                                </div>
                                                <div class="col-lg-6 intervall1">
                                                    <li role="presentation1" class="disabled">
                                                        <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" class="intervall">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" role="tabpanel" id="step1">
                                        <div class="wizard">
                                            <div class="wizard-inner">
                                                <ul class="nav nav-tabs1" role="tablist" style="padding-bottom: 10px;">
                                                    <div class="col-lg-4 div_tab">
                                                    <li role="presentation2" class="active">
                                                        <a href="#kaffees_div" data-toggle="tab" aria-controls="kaffees_div" role="tab" class="anchor_c">
                                                            <span>All coffees</span>
                                                        </a>
                                                    </li>
                                                </div>
                                                <div class="col-lg-4 div_tab1">
                                                    <li role="presentation3" class="disabled">
                                                        <a href="#espresso_div" data-toggle="tab" aria-controls="espresso_div" role="tab" class="anchor_e">
                                                            <span >Espresso</span>
                                                        </a>
                                                    </li>
                                                </div>
