                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col flex-row">
                                            <div class="text-center">
                                                ...
                                                <?php if($val['otstatus'] !='CANCELLED' || $val['otstatus'] !='COMPLETED' ){?><a href="javascript:void(0)" class="btn cancel_button" data-id="<?=$val['myitem_id']?>">Cancel Order</a><?php }?>
                                            </div>
                                        </div>
                                    </div>
                                <?php }else{?>
                                    ...
                                    <div class="col-md-6">
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Gesamtsumme</th>
                                                    <td><?php echo $sub = $order->total_amount+$shipPrice?> &euro;</td>
                                                </tr>
                                                <tr>
                                                    <th>inkl. 5 % MwSt. </th>
