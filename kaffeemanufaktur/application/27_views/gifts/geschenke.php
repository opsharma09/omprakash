...
<body>
                ...
                <div class="col-12">
                    <div class="categories">
                        ...
                        <div class="categoryNavLevel">
                             <?php $category_array =array("Kaffee","Espresso","Zubehör","Geschenke","Gutscheine");
                                $sub_category_array =array("Geschenkideen");
                             foreach ($category_array as $cat) {?>
                               <a <?php if($cat=='Geschenke'){?>href="<?= base_url('produkt-kategorie/'.com_slugify($cat)) ?>"<?php }elseif($cat=='Gutscheine'){?>href="<?= base_url('produkt-kategorie/'.com_slugify($cat)) ?>"<?php }elseif($cat=='Zubehör'){?>href="<?=base_url('produkt-kategorie/'.com_slugify('ZUBEHOER')) ?>"<?php }else{?>href="<?= base_url('produkt-kategorie/kaffee-espresso/'.com_slugify($cat)) ?>"<?php }if($cat==$option){ echo 'class="activeCategory"';}?>><?=$cat?></a> |
                        ...
                        <div class="categoryNavLevel">
                            <?php foreach ($sub_category_array as $cat) {?>
                               <a href="<?= base_url('produkt-kategorie/'.com_slugify('Geschenke')).'/'.com_slugify($cat) ?>" <?php if($cat==$option){ echo 'class="activeCategory"';}?>><?=$cat?></a> |
                            <?php } ?> <a href="<?= base_url('produkt-kategorie/'.com_slugify('Geschenke')) ?>">Alle Produkte</a>
                            <!-- <a href="">Geschenkideen</a> | <a href="" class="activeCategory">Alle Produkte</a> -->
                        </div>
                    </div>
                </div>
    ...
    <div class="product_wrapper">
        <div class="products text-center">
            <div class="container">
                <div class="row">
                    <?php $price_array = array(); foreach($pproducts as $key => $value){
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product">
                            <a href="<?=base_url('produkt/'.com_slugify($value['e_name']))?>" class="d-block">
                                ...
                                <?php if($is_package == 'N' || !empty($value['taste'])){
