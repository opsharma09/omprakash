          ...
          .card {
            ...
            <div class="bg">
              ...
              <div class="card">
                ...
                <h1 class="card__msg" style="color: red">Somthing Went Wrong</h1>
                <h1 class="card__msg" style="color: red"><?=isset($res)?$res:''?></h1>
                <div class="card__tags">
                    <a class="card__tag btn" href="<?=base_url()?>" style="margin-right: 5px" > Back to home</a>     
                </div>
