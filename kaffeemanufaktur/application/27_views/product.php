...
<body>
    ...
    <div id="helperBox">
        ...
        <div class="product_selector_inner">
            <form action="#">
                <div class="form-row">
                    <div class="col-12 back" <?php if($product[0]['category']==19 || $product[0]['category']==21 || $product[0]['category']==20 || $is_package == 'Y'){?>style="display: none" <?php } ?>>
                    ...
                    <div class="col-12 back">
                        <?php if($product[0]['category']==19 || $product[0]['category']==21|| $product[0]['category']==20 || $is_package == 'Y'){
                            if (!empty($product_details)) {
                                # code...
