    ...
    <section class="account">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <p class="no_subscriptions woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info">Keine gespeicherten Zahlungsmethoden gefunden.</p>
                    <a href="" class="button">Zahlungsmethode hinzufügen</a>
                </div>
            </div>
        </div>
    </section>
