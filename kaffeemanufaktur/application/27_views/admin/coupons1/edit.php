                            ...
                            <div class="col-sm-8 m-auto">
                                <form method="post" id="coupon_form">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" required name="description" id="description" placeholder="Enter Description about this offer"><?=$offers->description?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" required name="terms" id="terms" placeholder="Enter Offer Terms"><?=$offers->terms?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input class="form-control" required type="number" placeholder="Enter No of time allowed per user" value="<?=$offers->allowed_user_times?>" name="allowed_user_times" id="allowed_user_times">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
