                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input style="text-transform: uppercase" class="form-control" required type="text" placeholder="Enter Coupon Code" name="offer_code" id="offer_code">
                                                 <p  class="error-alert coupon_error" style="display:none;color: red" >* Coupon is already exist</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Category <span class="text-danger">*</span> :</label>
                                                    <select class="form-control category_select" name="category[]" id="hide_select" required multiple>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" required name="description" id="description" placeholder="Enter Description about this offer"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" required name="terms" id="terms" placeholder="Enter Offer Terms"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" required type="number" placeholder="Enter No of time allowed per user" name="allowed_user_times" id="allowed_user_times" min="1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
    ...
    function submit_coupon(){
        ...
        if(offer_code==''){
            ...
            return false;
                ...
                $.ajax({
                url: "<?=base_url('coupons/valid_coupon')?>",
                type: "POST",
