        ...
        <div class="card pl-4 pt-4 pr-4 pb-4">
            <div class="row">
                <div class="col-sm-6" style="padding-bottom: 40px">
                  <button class="btn btn-info float-right"><a href="<?php  echo base_url().'coupons/add'?>" class="btn btn-info btn-sm">Add New</a></button>
                </div>
                <div class="col-sm-4" style="padding-bottom: 40px">
                  <a class="btn btn-primary float-left" data-toggle="modal" data-target="#add_product_equipment" style="color:#ffffff"><i class="fas fa-plus" ></i> Import</a>
                </div>
                <div class="col-sm-6" style="padding-bottom: 40px">
                  <button class="btn btn-info float-left"><a href="<?php  echo base_url().'coupons/auto_add'?>" class="btn btn-info btn-sm">  Add Bulk Coupon</a></button>
                </div>
            </div>
            <div class="row">
    ...
    <div class="modal-content ">
        <form action="<?=base_url("coupons/coupons_bulk_import")?>" method="post" enctype="multipart/form-data">
            <div class="modal-header">
                <h4 id="defaultModalLabel">coupons Bulk Import &nbsp;&nbsp;&nbsp;<a href="<?=base_url("coupons/sample_coupon_export")?>" class="btn btn-sm btn-light">Sample</a></h4>
            </div>
