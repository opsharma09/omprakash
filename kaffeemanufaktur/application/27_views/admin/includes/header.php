...
<style type="text/css">
  section.content div.dataTables_wrapper div.dataTables_filter input {
    width: 50%;
    height: 40px;
    float: right;
}
    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('login/change_password') ?>" class="nav-link <?php if ($this->uri->segment(1)=='change_password'){ echo 'active';}?>">
              <i class="nav-icon fas fa-users"></i>
              <p>
                Change Password
              </p>
