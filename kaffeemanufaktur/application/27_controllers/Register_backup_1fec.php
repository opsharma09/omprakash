            ...
            if ($insert > 0) {
                ...
                $body =  '<html>
                    ...
                    $body1 =  '<html>
                                    ...
                                    <p style="padding-left:10px">Ein Benutzer hat sich registriert. Es gibt folgende Details des Benutzers:</p>
                                    
                                    <p style="padding-left:10px">User ID: "'.$insert.'"</p>
                                    <p style="padding-left:10px">User Name: "'.$data['firstname'].' '.$data['lastname'].'"</p>
                                    <p style="padding-left:10px">User Email ID: "'.$data['email'].'"</p>
