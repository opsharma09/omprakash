...
class Products extends CI_Controller
{
    ...
    public function product($id){
           ...
           // var_dump($availability);
                ...
                if($product_info[0]['category']==19 || $product_info[0]['category']==21 || $product_info[0]['category']==20 || $subcategory[0]['is_package']=='Y'){
                    ...
                    $data['type'] = $this->db->query("select * FROM availability where product_id = $pd_id AND variation_id = $vid order by price desc,size desc")->result_array();
