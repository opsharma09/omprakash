...
<body>
    ...
    <section class="cart">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-success alert-dismissible fade" id="warenkorb" role="alert">
                        ...
                        <div class="shop_table">
                            ...
                            <?php $totalPrice=$totalPrice+($val['myQuan']*$val['price']);}else{?>
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <p class="w-100 m-0"><?=$val['name']?></p>
                                        <p class="info"><?=$val['type']?>, <?=$val['size']?> <br>Personen: 1 <br> Datum: <?=date('d-M-Y',strtotime($val['start_date']))?> </p>
                                    </div>
                                     <div class="col"><?=$val['price']?> &euro;</div>
                                    <div class="col"><?=$val['myQuan']?></div>
                                    <div class="col"><?php echo $val['myQuan']*$val['price']?> &euro;</div>
