                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                <div class="newsletter_form">
                                    <!-- <form action="<?=base_url('home/news_latter_email')?>" method="post" > -->
                                        <div class="form-row">
                                            <div class="input-group" id="news_div">
                                                <input type="text" class="form-control" placeholder="Email Adresse eingeben" name="news_email" id="news_email">
                                                <div class="input-append" id="news_button"><button type="button" onclick="submit_news()" >Abonieren</button></div>
                                            </div>
                                            <ul>
...
function submit_news(){
        ...
        $.ajax({
            url: "<?=base_url('home/news_latter_email')?>",
            type: "POST",
            data: {news_email:news_email},
            success: function (response) {
                $('#news_div').html('<p>Einmalig einen 3 € Gutschein für den nächsten Einkauf in unserem Onlineshop sichern.</p><br><p style="padding:10px;background-color:green;color:#ffffff"  >Bitte bestätigen Sie Ihre Anmeldung!</p>');
            },
        });
    }
</script>