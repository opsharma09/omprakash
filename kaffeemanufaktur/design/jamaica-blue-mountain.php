            ...
            <div class="row">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Packshots-Abstrakt-Jamaica-Blue-Mountain.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/BlueMountain_falseZeichenfläche-1.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/BlueMountain_trueZeichenfläche-1.png" alt="fruits"></div>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Honig.png" alt="Beerig"></div><span>Honig</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Ananas.png" alt="Nussig"></div><span>Ananas</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Schwarztee.png" alt="Würzig"></div><span>Tabak</span>
            </div>
        </div>
