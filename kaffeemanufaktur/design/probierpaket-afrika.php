        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Probierpaket Afrika</h2>
                    <div class="productExcerpt">
                        <p>Im afrikanischen Hochland sind einige der interessantesten und fruchtigsten Kaffees der Welt zu finden. Entdecken Sie den besonderen Geschmack des ungezähmten Kontinents und genießen Sie ein außergewöhnliches Aroma mit unvergleichlichem Zusammenspiel aus feiner fruchtiger Säure und ausgeprägten Noten von Kakao, Zitrus, Himbeere, Grapefruit und mehr.</p>
                        <div><b>Im Paket enthalten:</b></div>
                        <p>Tanzania (80g) | Ruanda Inzovu (80g) | Bio Äthiopien Sidamo (80g) (Details siehe weiter unten)</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/ProbierpaketeElement-14-8.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>TANZANIA <br> (80 Gramm)</h2>
                                    <div>Der Anbau in besonderer Höhenlage von bis 2100m verleiht dieser afrikanischen Spezialität sein außergewöhnliches Aroma mit einem unvergleichlichen Zusammenspiel zartherber Noten und fein-fruchtiger Säure.</div>
                                    <div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>RUANDA INZOVU <br> (80 Gramm)</h2>
                                    <div>Im nordöstlichen Teil Ruandas wächst ein Spitzenkaffee, der durch seine enorme Fülle besticht. In Verbindung mit seiner angenehmen, leicht spitzen Säure entsteht eine kräftig harmonische Kaffeespezialität.</div>
                                    <div>
                                        <a href="" class="button btn-white">mehr erfahren</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>BIO ÄTHIOPIEN SIDAMO <br> (80 Gramm)</h2>
