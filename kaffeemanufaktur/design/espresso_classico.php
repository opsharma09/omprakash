        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Espresso Classico</h2>
                    <div class="productExcerpt">
                        <p>Eine Espressokomposition aus feinsten Arabicas Indiens und Südamerikas mit 20% hochwertigem indischem Robusta, die mit Ihrer Fülle und ausgeprägter Crema überrascht. Sortenrein geröstet.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/2015-EC.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Kulinarischer Botschafter 2015 / Ein echter Klassiker</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Ein echter Klassiker unter allen Espressi. Egal ob zum wachwerden am Morgen oder als kräftige Unterstützung am Nachmittag. Der Espresso Classico ist immer die richtige Wahl. Eine edle Komposition aus feinsten Arabicas Indiens und Südamerikas mit 20% hochwertigem indischem Robusta, die mit Ihrer Fülle und ausge¬prägter Crema überrascht.</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Erdnuss.png" alt="Beerig"></div><span>Erdnuss</span>
            </div>
            <div class="singleFlavorPictureWrapper">
