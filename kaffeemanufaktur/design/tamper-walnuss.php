         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>JoeFREX – Tamper Walnuss – 58mm</h2>
                     <div class="productExcerpt">
                         <p>Der elegant geformte Griff liegt geschmeidig in der Hand, weil Grifflänge und Gewicht in einem genau ausgewogenen Verhältnis stehen. Alle Griffe sind aus Holz gedrechselt. Die Griffe aus Ahorn und Nuss sind geölt, die aus Buche und Eiche lackiert.</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="images/2-hen-tamper-tamper-waltnut_300x300.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
