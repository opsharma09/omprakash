            ...
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    ...
                    <div class="productExcerpt">
                        <p>Messen Sie mit diesem Timer die Extraktionszeit von Espresso, die Brühzeit Ihres Filterkaffees oder auch die Zeit, die Ihr Tee ziehen muss. Unser Timer hat eine Start/Stop-Taste, eine Count-up/-down Funktion und ein leicht ablesbares LCD-Display.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/12-xti-timer-coffee-tea_300x300.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
-->
                    <div class="col-12 back">
                        <label for="mahlgrad">Lieferumfang</label>
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>Timer mit Batterie</option>
                        </select>
                    </div>
                    <div class="col-12">
