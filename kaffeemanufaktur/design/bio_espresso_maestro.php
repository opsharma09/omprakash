        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Bio Espresso Maestro</h2>
                    <div class="productExcerpt">
                        <p>50% edler und kräftiger Bio Robusta aus den Bergregionen Südindiens und 50% asiatische Spitzenarabicas aus den Western Ghats Indiens. Eine unglaublich geschmackvolle und kräftige Bio-Espresso-Mischung mit viel Koffein. Perfekt abgestimmt mit 50% edlem und kräftigen Robusta aus den Bergregionen Südindiens. Kräftig vollmundiges Mundgefühl mit intensiver Cremabildung und langanhaltendem Geschmack.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/2018-BEM.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Kulinarischer Botschafter NDS 2018</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Biologisch angebaut und fair gehandelt</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Kräftig im Geschmack. Fein fruchtige Nuancen mit einem Hauch von Zartbitterschokolade.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Muskat.png" alt="Beerig"></div><span>Würzig
                </span>
            </div>
            <div class="singleFlavorPictureWrapper">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Haselnuss.png" alt="Würzig"></div><span>Haselnuss</span>
            </div>
        </div>
