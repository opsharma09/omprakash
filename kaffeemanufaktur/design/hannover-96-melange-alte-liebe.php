...
<body>
            ...
            <div class="row">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Packshots-Abstrakt-neu-Okt.-201896-Kaffee-Alte-Liebe.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/Hannover96BG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/Hannover96FG.png" alt="fruits"></div>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Pfeffer.png" alt="Würzig"></div><span>Würzig</span>
            </div>
        </div>
