        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Cafflano Kompresso</h2>
                    <div class="productExcerpt">
                        <p>Cafflano® Kompresso ist der weltweit kompakteste und leichteste tragbare Zubereiter für authentischen Espresso, der ein Hydrauliksystem nach dem Pascalschen Prinzip verwendet, um die Extraktionskraft für den Espresso zu erhöhen. Das Pascalsche Prinzip (das Prinzip der Druckübertragung bei Flüssigkeiten) ist das Prinzip der Strömungsmechanik, das besagt, dass eine Druckänderung an einem beliebigen Punkt einer ruhenden, geschlossenen Flüssigkeit, unvermindert auf alle Punkte der Flüssigkeit übertragen wird. <br>Der Hydraulikkompressor des Cafflano® Kompresso ist so konstruiert, dass er einen Druck von mehr als 9 Bar beibehält, bis der Espresso vollständig extrahiert ist. Darüber hinaus maximiert der Dual-Modus (Drück- und Ziehgriffe) die Gewichtskraft.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/kafflano2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Espresso immer und überall</h1>
                            <p>Weltweit kompaktester und leichtester tragbarer Zubereiter für authentischen Espresso</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-lg-3 m-auto text-center">
                            <h2>Fakten</h2>
                            <p>Hydraulische Wasserkompression im Gegensatz zur typischen pneumatischen Luftkompression</p>
                            <p>Einzigartiges Kompressionsmodell-Design, das die Krafteffizienz maximiert</p>
                            <p>Nachhaltig und umweltfreundlich</p>
                            <p>Langlebig und hygienisch</p>
                            <p>Einfach zu bedienen und zu reinigen</p>
                            <p>Erschwinglich, Filter muss nicht ersetzt werden</p>
                            <p>International Patentiert (Gebrauchsmuster- und Designpatente)</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-9 col-lg-6 m-auto">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>18cm x 10cm</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>Max. Wassermenge</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>80ml</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>Korbfilterkapazität</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>15g</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>Mahlgradkörnung</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            <div class="col"><img src="images/kafflano2 (1).png" alt=""></div>
                            <div class="col"><span>+</span></div>
                            <div class="col"><img src="images/2015-EC.png" alt=""></div>
                        </div>
                    </div>
