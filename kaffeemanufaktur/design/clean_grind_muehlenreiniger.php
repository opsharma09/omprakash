        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>clean_grind_muehlenreiniger</h2>
                    <div class="productExcerpt">
                       <p>Der neu entwickelte Mühlenreiniger Clean-Grind ist ein Spitzenprodukt komplett basierend auf natürlichen Rohstoffen wie verschiedenen Getreidesorten. Mit diesem erstklassigen Produkt können Sie schnell und bequem den Totraum Ihrer Kaffeemühle reinigen.</p>
                        <p>Bei modernen Espressomühlen versagt das alte "Großmutter-Prinzip" der Reinigung durch Reis. Die neuen Maschinen bleiben stecken oder laufen nicht mehr an, was ein mühsames Aufschrauben und eine manuelle Reinigung der Mühle zur Folge hat. Für die heutigen Espressomühlen wird ein Mühlenreiniger benötigt, der die Mühle nicht blockiert, gleichzeitig aber den Totraum möglichst umfassend und gründlich reinigt. Außerdem darf der Reinigungsvorgang nicht die Mahlgrad-Einstellung der Mühle verändern. Der Mühlenreiniger von Clean-Grind bietet all diese Leistungsmerkmale.</p>
                        <p>Damit die Reinigung optimal funktioniert, bitten wir Sie folgende Schritte zu beachten: <br>
1. Entleeren Sie den Bohnenbehälter, lassen Sie die verbliebenen Kaffeebohnen leer laufen und reinigen Sie soweit wie möglich mit einem Mühlenpinsel vor. <br>
2. Stellen Sie die Mühle vor dem Reinigungsdurchlauf auf einen mittleren Mahlgrad. So verhindern Sie, dass sich die Mahleinstellung verschiebt. <br>
3. Nachdem ca. 40g CleanGrind durchgelaufen sind, können Sie wieder Kaffeebohnen einfüllen. Das erste Kaffeemehl mit den Resten des Reinigers bitte entsorgen. Während der ersten Mahlvorgänge können noch Partikel des Reinigers im Kaffeemehl enthalten sein, was Ihren Espresso geschmacklich jedoch nicht beeinträchtigt.</p>
                   <p>Die ölhaltigen und evtl. ranzigen Kaffeefette sind nun aus der Mühle entfernt. Sie können wieder köstlich frischen Cappuccino und Espresso herstellen.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/14-cg500-cleanyourmachine_300x300 (1).png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                           <h2>Ein Spitzenprodukt auf kompletter Naturbasis</h2>
                            <p>Für die Chemex Karaffen</p>
                        </div>
                    </div>
                </div>
            </div>
...
-->
                    <div class="col-12 back">
                        <label for="mahlgrad">Inhalt</label>
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>500g</option>
                        </select>
                    </div>
                    <div class="col-12">
