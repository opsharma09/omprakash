        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>El Salvador Finca Las Tinieblas</h2>
                    <div class="productExcerpt">
                        <p>Die Finca wurde 1930 gegründet und ist seitdem ein Familienbetrieb. Die Brüder Julio Eduardo und Mauricio Samour sind sehr stolz auf ihren qualitativ hochwertigen Spezialitätenkaffee.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Pakshot-El-Salvador-2020-NEU-Oktober.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <!--                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/BioBrasil_falseZeichenfläche-1.png" alt="fruits"></div>-->
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/bio-brasil_vordergrund1.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    ...
                    <div id="fruitsSmallText">
                        <p>Der Anbau erfolgt unter Schattenbäumen wie Guave oder Zedern. Der Erhalt der Biodiversität und die Schonung der natürlichen Ressourcen stehen im Vordergrund. Dafür wird so weit wie möglich auf den Einsatz von Chemie verzichtet. Das moderne Beneficio (die Aufbereitungsanlage) wird ständig erweitert und ermöglicht die Aufbereitung des Kaffees nach allen Regeln der Kunst, so entsteht ein Spezialitätenkaffee.</p>
                        <p></p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <h3>Varietät</h3>
                    <p class="mb-0">Pacamara</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Herkunft</h3>
                    <p class="mb-0">La Libertad, Tepecoyo, Cordillera del Balsamo</p>
                </div>
                <div class="col-md-4 col-sm-6">
                    <h3>Erntemethode</h3>
