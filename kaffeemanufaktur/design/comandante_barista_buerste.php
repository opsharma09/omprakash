        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Comandante Barista Bürste</h2>
                    <div class="productExcerpt">
                       <p>Material: 100% geräuchertes, natürliches Eichenholz und echtes Haar. <br>
Maße: Holz : 165 x 50mm <br>
Haar: 50mm <br>
Hersteller: Comandante</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/pi-comandante-max-barista-brush-2-eichejpgguetzli-out-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                           <h2>Echtes Haar</h2>
                            <p>...und 100% geräuchertes, natürliches Eichenholz</p>
                        </div>
                    </div>
                </div>
            </div>
...
-->
                    <div class="col-12 back">
                        <label for="mahlgrad">Hersteller</label>
