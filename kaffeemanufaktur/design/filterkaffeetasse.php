        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Filterkaffee-Tasse inkl. Untertasse Nr. 3 (220ml)</h2>
                    <div class="productExcerpt">
                        <p>Tasse und Untertasse aus Porzellan, dekorativ bedruckt mit dem Logo der Hannoverschen Kaffeemanufaktur.</p>
                    </div>
                </div>
            </div>
        </div>
