            ...
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    ...
                    <div class="productExcerpt">
                       <p>Ca. 35mm breiter Pinsel für die Reinigung der Espresso- oder Kaffeemühle. Griff aus lackiertem Holz mit Naturborsten. So reinigen Sie Ihre Mahlkoenig, Cassadio, Rancilio oder La Cimbali schnell! Für die Reinigung der Mahlscheiben empfehlen wir Ihnen die Reinigungsmittel von CleanYourMachine: das Clean-Grind auf Naturbasis.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/13_cbum_espresso_coffee_grinder_brush_300x300-1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                           <h2>für die Reinigung der Espresso- oder Kaffeemühle</h2>
                        </div>
                    </div>
                </div>
            </div>
...
-->
                    <div class="col-12 back">
                        <label for="mahlgrad">Breite</label>
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>ca. 35mm</option>
                        </select>
                    </div>
                    <div class="col-12">
