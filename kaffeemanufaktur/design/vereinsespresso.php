        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Vereinsespresso</h2>
                    <div class="productExcerpt">
                        <p>Mit jedem gekauften Pack Kaffee unterstützen Sie den hannoverschen Sport! Ein kräftiger, aromatischer Espresso mit vollmundiger Crema und würzigem Geschmack.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/packshot_kraftpapier_vereinskaffee_neu_1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Wir geben der Region was zurück!</h1>
                            <p>Gemeinsam stark!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div id="accessoriesIntroSectionBottomDecoration" style="	background-size: 100% 100%;	background-repeat: no-repeat;	background-image:url('data:image/svg+xml;base64,')	"></div>
        </div>
    </div>
