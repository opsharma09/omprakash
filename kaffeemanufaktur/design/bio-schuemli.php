            ...
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    ...
                    <div class="productExcerpt">
                        <p>Diese Mischung wurde von uns speziell für den Vollautomaten konzipiert. Das volle und runde Aroma der trocken aufbereiteten Arabica-Kaffees macht ihn zum perfekten Allrounder für alle Zubereitungsarten. Ein harmonischer Café Creme oder ein weicher, leicht schokoladiger Espresso. Ein geringer Robustaanteil verleiht unserem Schümli den Körper, welchen Sie gerade in Milchmixgetränken nicht mehr missen möchten.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/BioSchumliBG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/BioSchumliFG.png" alt="fruits"></div>
                    </div>
                </div>
                <div id="fruitsTextArea">
                    ...
                    <div id="fruitsSmallText">
                        <p>Kulinarischer Botschafter 2015 / biologisch angebaut und fair gehandelt</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Fein würziger Geschmack mit einer intensiven Crema und vollem Körper.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Zitrone.png" alt="Beerig"></div><span>Zitrone</span>
            </div>
            <div class="singleFlavorPictureWrapper">
