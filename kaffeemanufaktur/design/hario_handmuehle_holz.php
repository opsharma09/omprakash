        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Hario Handmühle Holz MM2</h2>
                    <div class="productExcerpt">
                        <p class="m-0">• Gut verarbeitete Hand-Kaffeemühle im Retro-Look aus Holz</p>
                        <p class="m-0">• Hochwertiges und langlebiges Kegelmahlwerk aus Keramik</p>
                        <p class="m-0">• Mahlgrad ist verstellbar und eignet sich für Herdkännchen, Filter und Stempelkanne</p>
                        <p class="m-0">• Schonende Mahlung durch geringe Hitzeentwicklung</p>
                        <p class="m-0">• Empfohlen für Herdkännchen, Filter und Stempelkanne. Für Espresso empfehlen wir eine elektrische Kaffeemühle, da der Mahlvorgang sehr kraftaufwendig und zeitintensiv ist.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/9b8e409fd5d668dc638b051028a037ef.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <p>Solide Kaffeemühle im Retro-Look</p>
                        </div>
                    </div>
                </div>
            </div>
...
-->
                    <div class="col-12 back">
                        ...
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>Holz</option>
                        </select>
                    </div>
                    <div class="col-12">
