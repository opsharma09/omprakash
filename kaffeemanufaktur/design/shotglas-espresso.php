         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Shotglas Espresso</h2>
                     <div class="productExcerpt">
                         <p>Shotglass zum Abmessen von Single und Double Shots eines Ristrettos und Espressos. <br> Pflege: Bitte nur feucht abwischen, in der Spülmaschine nutzt sich der Aufdruck ab. <br> Maße: 4,5 cm x 4,5 cm x 6,5 cm</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="images/12_xsg_espresso_shot_measuring_glasses_300x300.jpg" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>Shotglass zum Abmessen von Single und Double Shot eines Ristrettos und Espressos</h2>
                         </div>
                     </div>
                 </div>
             </div>
...
-->
                     <div class="col-12 back">
                         ...
                         <select name="" id="mahlgrad" class="form-control">
                             <option value="" disabled selected>Double Espresso</option>
                         </select>
                     </div>
                     <div class="col-12">
