             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>neu konzipierte und verbesserte Tamper Matte</h2>
                         </div>
                     </div>
                 </div>
             </div>
...
-->
                     <div class="col-12 back">
                         <label for="mahlgrad">Abmessung</label>
                         <select name="" id="mahlgrad" class="form-control">
                             <option value="" disabled selected>15 x 20 x 4,5 cm</option>
                         </select>
                     </div>
                     <div class="col-12">
