         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Kaffeelot mit Clip</h2>
                     <div class="productExcerpt">
                         <p>Praktisch auf zwei Arten: Unser Kaffeelot mit Clip. Zum einfachen Abmessen einer Tassenportion und zum anschließenden Verschließen der Kaffeetüten. Ein kleiner Wegbegleiter, der das Leben ein wenig vereinfacht.</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="images/coffee_spoon_clip_00033536_194_sb_online_store_1_1_.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
...
-->
                     <div class="col-12 back">
                         ...
                         <select name="" id="mahlgrad" class="form-control">
                             <option value="" disabled selected>Silber</option>
                         </select>
                     </div>
                     <div class="col-12">
