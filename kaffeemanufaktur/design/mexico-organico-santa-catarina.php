...
<body>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/BioMexico_falseZeichenfl%C3%A4che-1.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/BioMexico_trueZeichenfläche-1.png" alt="fruits"></div>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Apfel.png" alt="Nussig"></div><span>Apfel</span>
            </div>
            <div class="singleFlavorPictureWrapper">
