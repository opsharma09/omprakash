         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Motta Tamper 58mm “Bubinga„</h2>
                     <div class="productExcerpt">
                         <p>Der optimal geformte Griff ist aus dem sehr harten und robusten Bubinga-Edelholz gefertigt, das eine wunderschöne Maserung zeigt und angenehm in der Hand liegt.</p>
                         <p>Details: <br>Griffhöhe (bis zur Verschraubung): ca. 6,8 cm Gesamthöhe des Tampers bis zur Unterseite der Tamperbasis: ca. 8,8 cm</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="images/mottaBubinga.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h2>Robuster Tamper aus Bubinga-Edelholz</h2>
                             <p>liegt angenehm in der Hand</p>
                         </div>
                     </div>
                 </div>
             </div>
