            ...
            <div class="row">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Packshot-Espresso-Supremo.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/BioEspressoSupremo_BG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/BioEspressoSupremo_FG.png" alt="fruits"></div>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Zitrone.png" alt="Beerig"></div><span>Zitrus</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Limette.png" alt="Nussig"></div><span>Limette</span>
            </div>
            <div class="singleFlavorPictureWrapper">
