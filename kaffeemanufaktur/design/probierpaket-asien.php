        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Probierpaket Asien</h2>
                    <div class="productExcerpt">
                        <p>Probierpaket bestehend aus unseren drei beliebtesten Kaffees Asiens. Von Indien bis Java können Sie die samtig-milden Kaffees mit üppiger Fülle und Noten von Zimt, Feige und Karamell genießen.</p>
                        <div><b>Im Paket enthalten:</b></div>
                        <p>Java Jampit (80g) | Pang Khon Thailand (80g) | Indien Monsooned Malabar (80g) (Details siehe weiter unten)</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/ProbierpaketeElement-18-8.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>JAVA JAMPIT <br> (80 Gramm)</h2>
                                    <div>Sehr aromatischer, langsam gereifter Hochlandkaffee aus Java. Er besitzt trotz Feinheit und Eleganz eine üppige Fülle und entwickelt zimtige, haselnussähnliche Aromen mit einer gewissen Süße.</div>
                                    <div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>PANG KHON THAILAND<br> (80 Gramm)</h2>
                            ...
                            <div class="col-lg-4 col-md-6 mb-5">
                                ...
                                <div class="samplePackageContentsSingleCoffeeLower text-center">
                                    <h2>INDIEN MONSOONED MALABAR <br> (80 Gramm)</h2>
