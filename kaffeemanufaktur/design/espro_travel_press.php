        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Espro Travel Press</h2>
                    <div class="productExcerpt">
                        <p>Die Travel Press vom Hersteller Espro funktioniert ähnlich wie eine Stempelkanne. <br>Sie verfügt über ein sogenanntes Mikrofiltersystem, das 12-mal feiner ist als bei einer herkömmlichen Stempelkanne. <br>Der Filter verfügt über eine Gummidichtung, die verhindert, dass der Kaffee nachextrahiert. <br>Durch die isolierten Edelstahlwände hält der Kaffee mehrere Stunden warm, was die Travel Press perfekt für unterwegs macht. <br>Mit Filter weist die Travel Press ein Fassungsvermögen von 300ml auf. <br>Zubereitung und Reinigung sind schnell, einfach und unkompliziert.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/3-361.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-lg-3 m-auto text-center">
                            <h2>Fakten</h2>
                            <p>Edles Design aus Edelstahl</p>
                            <p>Isolierte Edelstahlwände halten den Kaffee warm</p>
                            <p>Doppeltes Mikrofiltersystem</p>
                            <p>Kaffee zieht nicht nach</p>
                            <p>Fassungsvermögen: Mit Filter 300ml, ohne Filter 450ml</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 m-auto">
                    <div class="accessoriesCombinationSectionInner">
                        <div class="row">
                            <div class="col"><img src="images/3-361.png" alt=""></div>
