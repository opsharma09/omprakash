        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Fellow Stagg EKG Wasserkocher</h2>
                    <div class="productExcerpt">
                        <p>Der Stagg EKG ist die perfekte Kombination aus schnörkelloser Ästhetik und richtig guter Qualität. Dieser wunderschöne Wasserkocher mit digitaler Temperaturvorwahl ist ideal für Freunde asiatischer Teezubereitung. Der Schwanenhals ermöglicht präzises und sanftes Abgießen auf zarte Teeblätter und in kleinste Kännchen. Doch nicht nur das puristische Design überzeugt, der Wasserkocher ist unkompliziert in der Bedienung und sehr hochwertig verabeitet.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/1_k.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Hochwertiger Wasserkocher</h1>
                            <p>Perfekte Kombination aus schnörkelloser Ästhetik und richtig guter Qualität</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="">
                <div class="form-row">
                    <div class="col-12 back">
                        <label for="mahlgrad">Wert</label>
                        <select name="" id="mahlgrad" class="form-control">
                            <option value="" disabled selected>10,00 &euro;</option>
                        </select>
                    </div>
                    <div class="col-12 back">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-lg-3 m-auto text-center">
                            <h2>Fakten</h2>
                            <p>Gradgenaue Temperaturvoreinstellung von 40 bis 100°C</p>
                            <p>Warmhaltefunktion bis 60 Minuten</p>
                            <p>Minimalistisches Design mit nur einem schlichten Drehknopf und digitalem Display und Stoppuhr</p>
                            <p>Handschmeichelnder, ergonomischer Griff mit angenehmer Schwerpunktverlagerung</p>
                            <p>Präzisions-Schwanenhals für lansgames, tropffreies Abgießen</p>
                            <p>Hold-Schalter für die Wamhaltefunktion und ein weiterer Schalter für die Wahl Celsius/Fahrenheit</p>
                            <p>1200 Watt Leistung / 220V / EU Stecker</p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                            <span>ca. 29 cm x 17 cm x 20 cm</span>
                        </div>
                        <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                            <span>Gewicht</span>
                        </div>
            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-3 px-md-2 px-3 text-center"><img src="images/2.png" alt=""></div>
                            <div class="col-lg-3 px-md-2 px-3 text-center"><img src="images/4.png" alt=""></div>
                            <div class="col-lg-3 px-md-2 px-3 text-center"><img src="images/5.png" alt=""></div>
                            <div class="col-lg-3 px-md-2 px-3 text-center"><img src="images/3.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-11 m-auto">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h2 class="customerReviewsCaptions text-md-left text-center">Bewertungen</h2>
