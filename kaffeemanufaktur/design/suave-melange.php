...
<body>
            ...
            <div class="row">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/suave-melange.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitParkingPositionOuter">
                    <div id="fruitParkingPositionInner" style="width:calc(66% + 10px - (8%));">
                        <div class="fruitElementWrapper" style="z-index:0;"><img class="fruitElement" src="images/SuaveMelangeBG.png" alt="fruits"></div>
                        <div class="fruitElementWrapper" style="z-index:2;"><img class="fruitElement" src="images/SuaveMelangeFG.png" alt="fruits"></div>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Haselnuss.png" alt="Nussig"></div><span>Haselnuss</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Zimt.png" alt="Würzig"></div><span>Zimt</span>
            </div>
        </div>
