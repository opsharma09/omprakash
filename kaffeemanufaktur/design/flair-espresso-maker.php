        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Flair Espresso Maker</h2>
                    <div class="productExcerpt">
                        <p>Leicht zu handhabende, mobile Espresso-Lösung, die ohne Strom auskommt!</p>
                        <p>Das benötigte heiße Wasser muss von einer externen Quelle kommen, sei es die Herdplatte, der Campingkocher, das Lagerfeuer oder die Mikrowelle.</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/flair-espresso-maker-signature-bundle-set.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Mobile Handhebelmaschine für perfekten Espresso</h1>
                            <p>Ganz neu: Serienmäßig mit bottomless Filterholder</p>
                        </div>
                    </div>
                </div>
            </div>
...
-->
                    <div class="col-12 back">
                        <label for="mahlgrad">Druck</label>
                    ...
                    <div class="row">
                        <div class="col-md-9 col-lg-6 m-auto">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Koffergröße</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>32cm x 23cm x 8cm</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Größe der Standfläche</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>30cm x 15cm</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Kapazität des Wasserzylinders</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>65ml</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Druck mittels Handhebel</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>zwischen 8 Bar und 16 Bar (abhängig vom Mahlgrad und Tamperkraft)</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Durchlaufzeit des Espresso</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>25 Sekunden (ungefähr 8 Bar) bis 45 Sekunden (ungefähr 16 Bar)</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Kapazität des Filters</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>zwischen 17 g. bis 28 g. gemahlener Espressobohnen</span>
                                </div>
                                <div class="col-md-6 text-md-right text-center pt-3 pb-2 border-right">
                                    <span>Espressomenge</span>
                                </div>
                                <div class="col-md-6 text-md-left text-center pt-3 pb-2 border-left">
                                    <span>etwa 50 bis 60ml</span>
                                </div>
                            </div>
                        </div>
                    </div>
