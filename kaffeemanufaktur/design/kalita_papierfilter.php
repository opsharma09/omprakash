        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Kalita – Wave #185 Papierfilter 100 Stk. weiß</h2>
                    <div class="productExcerpt">
                        <p>Für Kalita und December Dripper geeignet</p>
                    </div>
                </div>
                <div class="packshot">
                    <div class="packshotPosition position-static">
                        <img src="images/3-358.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-4 m-auto">
                        <div class="content">
                            <h1>Für Kalita und December Dripper geeignet</h1>
                        </div>
                    </div>
                </div>
            </div>
