        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>96 Espresso Campione</h2>
                    <div class="productExcerpt">
                        <p>Ob Espresso, Cappuccino oder Latte Macchiato, in jeder Phase des Genusses überzeugt er mit Charakter, leichter Schokoladennote und einer ausgeprägten Crema. Der Original Hannover 96 Espresso "Campione". Rassig, kraftvoll und mit großer Leidenschaft - das gilt nicht nur auf dem Platz.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Packshots-Abstrakt-neu-Okt.-2018Espresso-Campione.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Aromen-75.png" alt="Beerig"></div><span>Kakao</span>
            </div>
            <div class="singleFlavorPictureWrapper">
