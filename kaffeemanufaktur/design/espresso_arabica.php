        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Espresso Arabica</h2>
                    <div class="productExcerpt">
                        <p>Mild und leicht fruchtig im Geschmack mit einer nachhaltigen schokoladigen Note und einer überraschend intensiven Crema.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                            <div><img src="images/a-1.png" alt=""></div>
                            <div><img src="images/b.png" alt=""></div>
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Packshots-Abstrakt-neu-Okt.-2018Espresso-Arabica.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Mild und leicht fruchtig im Geschmack mit einer nachhaltigen schokoladigen Note und einer überraschend intensiven Crema.b</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Aromen-75.png" alt="Beerig"></div><span>Schokolade</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Zitrone.png" alt="Nussig"></div><span>Zitrone</span>
            </div>
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Muskat.png" alt="Würzig"></div><span>Muskat</span>
            </div>
        </div>
