        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 text-center order-md-last order-lg-first">
                    <h2>Espresso Clemente</h2>
                    <div class="productExcerpt">
                        <p>Erlesene Hochlandarabica aus Mittelamerika, kombiniert mit 30% gewaschenen indischen Robustabohnen komponieren einen außergewöhnlichen Espresso. Sortenrein geröstet mit ausgeprägter Crema.</p>
                        <h6>geeingnet für</h6>
                        <div class="image">
                ...
                <div class="packshot">
                    <div class="packshotPosition">
                        <img src="images/Packshots-Abstrakt-neu-Okt.-2018Espresso-Clemente.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fruitsSection">
                ...
                <div id="fruitsTextArea">
                    <div id="fruitsBigText">
                        <h1>Ein leichter Start in den Tag</h1>
                    </div>
                    <div id="fruitsSmallText">
                        <p>Ein leichter Start in den Tag aus einer feinen Auswahl besonderer Spitzenkaffees aus den Hochländern Südamerikas und einem hochwertigen Robusta Südindiens. Wie der Name schon verrät ist dieser Espresso unsere milde und trotzdem vollmundige Alternative mit ausgeprägter Crema.</p>
                        <p></p>
                    </div>
                </div>
    ...
    <div id="flavorSection">
        ...
        <div id="flavorTopContainer">
            <div id="flavorTopTextColumn">
                ...
                <p>Eine feine Süße, eine spannende Würze und leichte schokoladige Nuancen finden sich in der Tasse wieder.</p>
            </div>
        ...
        <div id="flavorProfileContainer">
            ...
            <div class="singleFlavorPictureWrapper">
                <div class="singleFlavorPictureWrapperInner"><img src="images/Rosmarin.png" alt="Nussig"></div><span>Rosmarin</span>
            </div>
            <div class="singleFlavorPictureWrapper">
