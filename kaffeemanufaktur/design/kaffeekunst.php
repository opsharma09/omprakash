         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-4 text-center order-md-last order-lg-first">
                     <h2>Kaffeekunst – einfach selber machen – mit 450 farbigen Schritt-für-Schritt-Fotos</h2>
                     <div class="productExcerpt">
                         <p>Die hohe Kunst der Dekoration. Mit diesem Buch können Sie zahlreiche Bilder auf Ihren Kaffee "malen". In 450 Bildern zeigt der Barista Tamang Schritt für Schritt sein Können. Ein Buch für alle Kaffeeliebhaber und -künstler.</p>
                     </div>
                 </div>
                 <div class="packshot">
                     <div class="packshotPosition position-static">
                         <img src="images/kaffeekunst.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
...
-->
                     <div class="col-12 back">
                         ...
                         <select name="" id="mahlgrad" class="form-control">
                             <option value="" disabled selected>Dhan tambag</option>
                         </select>
                     </div>
                     <div class="col-12">
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-md-5 col-lg-4 m-auto">
                         <div class="content">
                             <h1>mit 450 farbigen Schritt-für-Schritt-Fotos</h1>
                             <p>60 großartige Motive aus Milchschaum - von Latte Art Champion Dhan Tamang</p>
                         </div>
                     </div>
                 </div>
             </div>
